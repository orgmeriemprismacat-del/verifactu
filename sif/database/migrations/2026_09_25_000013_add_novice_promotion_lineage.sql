...
CREATE TABLE IF NOT EXISTS novice_promotion_application_transfer (
    ...
    PREVIOUS_UUID_TRANSFER CHAR(36) NULL,
    ...
    UNIQUE KEY uq_novice_transfer_previous (PREVIOUS_UUID_TRANSFER),
    ...
    CONSTRAINT fk_novice_transfer_previous
        FOREIGN KEY (PREVIOUS_UUID_TRANSFER) REFERENCES novice_promotion_application_transfer(UUID_TRANSFER),
    ...
    CONSTRAINT chk_novice_transfer_source CHECK (
        (PREVIOUS_UUID_TRANSFER IS NULL AND (
        ...
        OR (PREVIOUS_UUID_TRANSFER IS NOT NULL
            AND PREVIOUS_UUID_TRANSFER <> UUID_TRANSFER
            AND UUID_ORIGINAL_APPLICATION IS NULL AND UUID_DERIVED_APPLICATION IS NULL)
    ),
