...
if (Accés Moodle confirmat després d'alta manual?) then (Sí)
  ...
  :Mostrar l'estat verificat; secretaria prepara a partir d'una plantilla existent i envia MANUALMENT el correu després de l'alta real, també amb butlletí No (DEC-108-05b/c/d/e). El missatge només informa de l'accés activat, sense enllaç ni instruccions de claus; les claus s'han conservat o facilitat durant l'alta al campus. Obrir la pàgina no ha de disparar cap correu automàtic;
else (No)
