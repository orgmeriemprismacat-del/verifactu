...
partition "Servidor de sol·licituds" {
  ...
  :El correu d'accés activat s'envia per secretaria NOMÉS després de l'alta manual efectiva (DEC-108-05b), també amb butlletí No;
...
:El correu operatiu d'accés activat és POSTERIOR a l'alta manual de secretaria (DEC-108-05b), no un segon correu automàtic d'aquest endpoint; automatització desitjada per al 2027 i fora d'abast;
