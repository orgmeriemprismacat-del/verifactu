...
5. **DEC-108-05e ACORDADA:** el correu manual posterior de secretaria **només informa que ja hi ha accés activat, sense enllaç al campus ni instruccions per obtenir claus**. Si la persona ja era membre conserva les credencials; si encara no ho era, en fer-ne l'alta al campus se li faciliten les claus per un circuit diferent del correu de confirmació. No inferir el mecanisme concret ni incloure credencials reals en aquest document.
...
| Missatge d'accés i credencials del campus | **DEC-108-05e ACORDADA (22/09/2026):** la plantilla manual d'accés activat **només informa que ja es pot accedir**; no inclou l'enllaç al campus ni instruccions de claus. Si ja era membre, manté les claus que tenia; si no ho era, en fer l'alta al campus se li faciliten les claus per un circuit separat del correu manual. Pendent de contrastar el canal i procediment real de lliurament de claus i el text literal de la plantilla. |
...
opt Hi ha sol·licitud nova vàlida
 ...
 alt La persona ja era membre del campus
  ...
  C-->>P: Facilitar claus en fer l'alta [mecanisme i canal per verificar]
 end
 SEC-->>P: Enviar MANUALMENT PLANTILLA EXISTENT: accés activat (sense enllaç ni instruccions de claus) [DEC-108-05b/c/d/e; també butlletí No]
end
