...
| Tastet expirat | **DEC-108-03a ACORDADA (22/09/2026):** la persona només es pot tornar a inscriure si secretaria o suport ho autoritza. La caducitat no habilita una alta o renovació automàtica; cal verificar autorització vinculada a persona i tastet abans de la nova alta. El procediment, vigència i registre concret resten per definir, i no són codi ja implementat. |
