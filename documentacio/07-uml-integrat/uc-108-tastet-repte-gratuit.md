...
opt Hi ha sol·licitud nova vàlida
 ...
 and Circuit independent de claus
  opt Persona nova que no rep el correu de claus
   ...
   Note over SEC,P: DEC-108-05m precisada: DESPRÉS de concedir la pròrroga, informar per CORREU la persona que TINDRÀ 7 DIES D'ACCÉS, SENSE data exacta de venciment; remitent i procediment per contrastar
  end
 end
end
