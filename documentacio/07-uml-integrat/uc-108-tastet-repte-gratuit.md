...
opt Hi ha sol·licitud nova vàlida
 ...
 and Circuit independent de claus
  opt Persona nova que no rep el correu de claus
   ...
   Note over SEC,P: DEC-108-05m/n: DESPRÉS de concedir la pròrroga, ISA O SECRETARIA envien MANUALMENT el CORREU que informa que TINDRÀ 7 DIES D'ACCÉS, SENSE data exacta de venciment; no autoenviament del campus
  end
 end
end
