...
5. **DEC-108-05b ACORDADA:** després que secretaria hagi completat manualment l'alta i s'hagi activat realment l'accés, **secretaria REDACTA I ENVIA MANUALMENT un correu operatiu a la persona per informar-la que ja pot accedir al campus** (DEC-108-05c), sense enviament automàtic del web/campus en aquesta fase. És diferent del correu de sol·licitud rebuda i s'envia independentment del «Sí/No» del butlletí, també amb «No». Cal verificar el procediment, el destinatari i l'evidència real de l'enviament sense pressupostar-ne el mecanisme tècnic. En reintent equivalent no es genera una nova entrada fiscal/econòmica ni s'atorguen dos accessos contradictoris.
...
| Redacció i enviament del correu d'accés | **DEC-108-05c ACORDADA (22/09/2026):** per ara secretaria **redacta i envia manualment** el correu operatiu després de l'alta efectiva al campus. No implementar enviament automàtic d'aquest missatge en la fase actual; continuar separant correu de recepció i consentiment del butlletí. Pendent de contrastar plantilla/contingut, destinatari i traça del procediment manual. |
...
opt Hi ha sol·licitud nova vàlida
 ...
 SEC-->>P: Redactar i enviar MANUALMENT correu operatiu: ja pots accedir [DEC-108-05b/c; també butlletí No; procediment per verificar]
end
