...
opt Hi ha sol·licitud nova vàlida
 ...
 and Circuit independent de claus
  opt Persona nova que no rep el correu de claus
   ...
   Note over SEC,C: DEC-108-05j/k: si ha impedit entrar durant part de la setmana, concedir NOVA SETMANA COMPLETA des de la RESOLUCIÓ; acreditar moment i execució Moodle
  end
 end
end
