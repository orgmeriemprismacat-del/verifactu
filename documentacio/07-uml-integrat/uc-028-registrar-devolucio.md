...
autonumber
actor O as Operador
participant R as ManualRefundService [PHP real]
participant B as ManualRefundPayloadBuilder [PHP real]
participant P as PaymentService [PHP real]
participant DB as payment_transaction/allocation [SQL]
O->>R: registerByUuid(FACTURA_A, amount=40, reference=RET-1)
