...
flowchart TD
  ...
  GPR --> GMAIL["DESPRÉS de concedir la pròrroga, avisar la persona per CORREU de la NOVA DATA DE VENCIMENT (DEC-108-05m); remitent i mecanisme pendents de contrastar"]
