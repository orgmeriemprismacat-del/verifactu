...
flowchart TD
  ...
  GPR --> GMAIL["DESPRÉS de concedir la pròrroga, avisar la persona per CORREU que TINDRÀ 7 DIES D'ACCÉS (DEC-108-05m precisada), SENSE DATA EXACTA DE VENCIMENT; remitent i mecanisme pendents de contrastar"]
