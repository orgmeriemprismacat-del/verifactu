...
flowchart TD
  ...
  GIN -.-> GPR["Si la incidència impedeix entrar durant part de la setmana: PRORROGAR l’accés per compensar el temps perdut (DEC-108-05j); còmput i execució pendents"]
