...
flowchart TD
  ...
  GIN -.-> GPR["Si la incidència impedeix entrar durant part de la setmana: NOVA SETMANA COMPLETA d’accés DES DE LA RESOLUCIÓ (DEC-108-05j/k); venciment real per verificar"]
