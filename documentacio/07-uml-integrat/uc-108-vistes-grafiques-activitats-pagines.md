...
flowchart TD
  ...
  M -->|Sí| N["UC-125: registrar Sí independent i gestionar confirmació segons decisió encara oberta DEC-108-04"]
...
flowchart TD
  ...
  F -->|Sí| G["Mostrar activació real per secretaria i venciment una setmana després, si estan verificats (DEC-108-02b)"]
  F -->|No| H["Mostrar sol·licitud rebuda / alta al campus en 24–48 h laborals; una setmana només des de l'activació efectiva (DEC-108-02a/b)"]
