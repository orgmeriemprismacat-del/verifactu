...
### 1.6. Pantalla concreta de factura abans del cobrament: cobertura d'empresa (25/09/2026)

[Auditoria d'activitats del formulari en tres passos](02-auditoria-pantalla-factura-abans-pagar-2026-09-25.md) i [UC-004 funcional, apartat 22](../06-fitxes-funcionals/uc-004.md#22-fitxa-funcional-per-accions-reals-de-generar-factura-abans-de-pagar-25092026). En el codi de pantalla, seleccionar dues inscripcions del **mateix curs i edició** acumula els seus `A_PAGAR` de l'HTML, tria un receptor d'entitat per text i envia el conjunt d'IDs a l'emissor llegat. El [backend L13255–13372](../../codi-drive/intranet-actual/Intranet.php#L13255-L13372) resol la raó social via LIKE, crea una sola factura llegada i vincula els IDs per UPDATE, però **no es veu en aquest mètode un servei de repartiment de fons reals, comprovació de cobertures SIF existents, clau d'operació idempotent ni coordinació transaccional de tot el conjunt**. Una empresa que paga més tard genera UC-002 de cobrament i atribucions individuals, no una altra factura.

**Variants a mantenir diferenciades:** empresa que cobreix diverses persones del mateix curs/edició; participant de baixa o de canvi després d'emetre; import pendent i posterior cobrament parcial; import comercial llegat diferent dels cobraments reals; empresa/receptor diferent del participant; selecció/reintent del navegador que repeteix IDs. Les comprovacions FAP-T01–06 i les proves específiques UC-021 són definides, **no executades**. No assumir que els criteris de receptor o la política de cursos/edicions diferents s'han ampliat a partir del nom del cas d'ús.
