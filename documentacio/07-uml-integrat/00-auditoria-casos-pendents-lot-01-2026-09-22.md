...
| **AUD-108-DEC-PENDENT** | La via per sol·licitar el desbloqueig, la pantalla/servei que utilitza secretaria/suport, la vigència i la reutilització del permís encara **NO estan definides**. **Sol·licitud pendent (DEC-108-03b) i accés actiu (DEC-108-03c) ja ACORDATS.** Continua oberta la política davant baixa/denegació. | **NO inventar la implementació** fins a definir les regles restants. La decisió sobre accessos caducats no s'aplica a peticions pendents ni a accessos actius. |
