...
| **AUD-108-DEC-PENDENT** | La via per sol·licitar el desbloqueig, la pantalla/servei que utilitza secretaria/suport, la vigència i la reutilització del permís encara **NO estan definides**. **La política de sol·licitud pendent ja està ACORDADA (DEC-108-03b).** Continuen obertes les decisions davant accés actiu i baixa/denegació. | **NO inventar la implementació** fins a definir les regles restants. La decisió sobre accessos caducats no s'aplica a les peticions pendents. |
