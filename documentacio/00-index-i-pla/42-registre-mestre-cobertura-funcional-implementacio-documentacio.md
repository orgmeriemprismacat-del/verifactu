...
**RM-003 · P0 · 192 pantalles i els seus estats.** DOC: per a cadascuna, desglossar botons, formularis, permisos, errors, accions asíncrones, correus i efectes; completar les 25 files amb mapatge provisional i revisar TAMBÉ les altres 167. Identificar captures actual/final i la ruta del codi real. IMP: adaptar cada acció fiscal/econòmica al SIF, no només modificar la maqueta. SORTIDA: cap acció sensible de pantalla sense UC i test d'usuari autoritzat/no autoritzat.
...
**Fase A — font actual i cobertura (RM-001–008, RM-024 en paral·lel):** completar inventari i decisions, classificar totes les accions i variants, actualitzar fitxes i diferenciar codi actual/final. **Porta A:** tota ruta activa crítica amb UC, dades, actor, variant i test; les absències consten com a candidates explícites, no com a «cobertes».
