...
- **UC-108 · DEC-108-03a ACORDADA (22/09/2026):** un accés a tastet caducat permet una nova inscripció **només amb autorització de secretaria o suport**. Cap alta o reactivació automàtica. La fitxa funcional, els dos jocs de diagrames i les proves d'acceptació d'aquest cas incorporen el control; el mecanisme concret d'autorització, el PHP i les proves continuen pendents.
