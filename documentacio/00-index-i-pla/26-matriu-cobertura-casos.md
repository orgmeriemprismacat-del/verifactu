...
| Grup de persones | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/06-integracio-redsys-pay-prisma.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `04-estat-final/15-estat-final-sistema.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Criteri tancat i circuits CLI preparats: snapshot `GRUP`, factura amb una linia per participant, receptor `respGrups`, relacions no visibles a alumne, Redsys manual de preproduccio i transferencia manual de `Passar pagaments` amb `--sync-legacy` opcional post-SIF. Falta executar PHP/MySQL de test, validar SQL final `descomptes_grup` abans d'activacio real i conservar evidencies/captures. |
...
| Empresa/responsable paga inscripcions | ESPECIFICACIO OPERATIVA | `03-canvis-pendents/07-pantalles-intranet.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `04-estat-final/16-estat-final-pantalles.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `05-governanca-operacio/21-seguretat-permisos-accessos.md`, `05-governanca-operacio/22-manual-operatiu-intern.md`, `05-governanca-operacio/23-annex-captures-pantalla.md` | Receptor, cobertura autoritzada, avisos, permisos i evidencies definits. Falta implementacio, prova executada i captura final. |
...
| Compensacio/saldo | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `04-estat-final/15-estat-final-sistema.md`, `04-estat-final/18-estat-final-operacio-incidencies.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Criteri tancat i circuit CLI preparat: saldo/compensacio no edita imports, crea `credit_balance`, s'usa com `COMPENSATION`/`COMPENSACIO` amb `payment_allocation` `CREDIT_COMPENSATION`, resta saldo de manera idempotent i no emet factura nova. Falta execucio PHP/MySQL de test i evidencies de preproduccio. |
| Pagaments fraccionats | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `04-estat-final/18-estat-final-operacio-incidencies.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Criteri tancat i circuit CLI manual preparat: cada fraccio es `payment_transaction`, cada assignacio es `payment_allocation`, idempotencia `MANUAL|FRACCIO|ID_INSC:{ID_INSC}|DATA:{DATA}|IMPORT:{IMPORT}|USUARI:{USUARI}`, sense duplicar factura ni registre fiscal. Falta execucio PHP/MySQL de test, visualitzacio final i Redsys fraccionat real si aplica. |
| Pagament morositat/reclamacio | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/08-correus-i-plantilles.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Circuit CLI preparat: una reclamacio no rectifica ni emet factura; quan arriba cobrament sobre factura SIF existent, `ClaimPaymentService` registra `registerPayment()` amb assignacio `CLAIM_PAYMENT`, idempotencia `CLAIM|REF:{REF}` o fallback per factura/data/import/usuari, sense registre fiscal nou. Falta pantalla/URL/correus finals i execucio PHP/MySQL de test. |
...
| Factura rectificativa R | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `04-estat-final/15-estat-final-sistema.md`, `04-estat-final/18-estat-final-operacio-incidencies.md`, `04-estat-final/05-model-bd-sif.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Criteri tancat i circuit CLI manual preparat: serie `R`, relacio directa a `factura_rectificacio`, motiu controlat, mode `DIFERENCIES` o `SUBSTITUCIO`, original marcada `RECTIFIED` i sense pagament ni legacy sync en aquest tall. Falta execucio PHP/MySQL de test i validacio fiscal puntual abans de produccio. |
...
| Devolucions | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `04-estat-final/18-estat-final-operacio-incidencies.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Criteri tancat i circuit manual preparat: `REFUND` com moviment economic contra factura existent, rectificativa si redueix factura emesa i possible combinacio amb saldo. Falta execucio PHP/MySQL de test i validacio operativa de Redsys/transferencia si cal. |
| Factura manual | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `04-estat-final/15-estat-final-sistema.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Criteri tancat i circuit CLI preparat: intranet autoritzada -> `issueInvoice()`, `source_type = MANUAL`, usuari intern obligatori, linies/snapshot fiscal, idempotencia per referencia o usuari/data/hash i pagament opcional inicial dins payload. Falta pantalla final, correus/enllac segur, execucio PHP/MySQL de test i evidencies. |
...
| Migracio factures historiques | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `04-estat-final/15-estat-final-sistema.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Circuit CLI preparat: importa factura historica com `NO_VERIFACTU`, conserva `NUM_VISIBLE`, serie/any/numero, linies, relacio `HISTORIC_LINK` i document antic amb hash si existeix; no crea hash/registre AEAT retroactiu ni altera `fiscal_sequence`. Falta execucio PHP/MySQL de test, informe de control agregat i validacio de totals. |
...
| Passar pagaments | ESPECIFICACIO OPERATIVA | `03-canvis-pendents/07-pantalles-intranet.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `04-estat-final/16-estat-final-pantalles.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `05-governanca-operacio/21-seguretat-permisos-accessos.md`, `05-governanca-operacio/22-manual-operatiu-intern.md`, `05-governanca-operacio/23-annex-captures-pantalla.md` | Flux, bloquejos, avisos, permisos i evidencies definits. Falten cossos reals de cerca/modal, implementacio SIF, proves executades i captures finals. |
| Generar factura abans de pagar | ESPECIFICACIO OPERATIVA | `03-canvis-pendents/07-pantalles-intranet.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `04-estat-final/16-estat-final-pantalles.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `05-governanca-operacio/21-seguretat-permisos-accessos.md`, `05-governanca-operacio/22-manual-operatiu-intern.md`, `05-governanca-operacio/23-annex-captures-pantalla.md` | Flux, validacions, avisos i evidencies definits. Falten implementacio SIF, proves executades, captures finals i comprovacio dels metodes. |
| Consulta - Edita - Anula factura | ESPECIFICACIO OPERATIVA | `03-canvis-pendents/07-pantalles-intranet.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `04-estat-final/16-estat-final-pantalles.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `05-governanca-operacio/21-seguretat-permisos-accessos.md`, `05-governanca-operacio/22-manual-operatiu-intern.md`, `05-governanca-operacio/23-annex-captures-pantalla.md` | Accions per estat, bloquejos, permisos, logs i evidencies definits. Falten implementacio SIF, cataleg de motius, proves executades i captures finals. |
...
| Factures manuals | IMPLEMENTACIO TECNICA PREPARADA | `03-canvis-pendents/04-fluxos-facturacio.md`, `03-canvis-pendents/11-inventari-canvis-pendents.md`, `00-index-i-pla/29-pla-implementacio-tecnica-sif.md` | Circuit CLI de preproduccio preparat amb `ManualInvoicePayloadBuilder`, `ManualInvoiceService`, `preview-manual-invoice.php` i `process-manual-invoice.php`. Falta implementar pantalla, permisos finals, correus/enllac segur, execucio PHP/MySQL de test i captures/evidencies. |
...
| Apartat VERI*FACTU intranet | ESPECIFICACIO OPERATIVA | `03-canvis-pendents/07-pantalles-intranet.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `04-estat-final/16-estat-final-pantalles.md`, `04-estat-final/25-panell-sif-pay-prisma.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `05-governanca-operacio/21-seguretat-permisos-accessos.md`, `05-governanca-operacio/22-manual-operatiu-intern.md`, `05-governanca-operacio/23-annex-captures-pantalla.md` | Indicadors, avisos, notificacions i incidencies definits. Falten implementacio UI, endpoint resum, prova executada i captures finals. |
| Intranet alumne | ESPECIFICACIO OPERATIVA | `03-canvis-pendents/07-pantalles-intranet.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `04-estat-final/16-estat-final-pantalles.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `05-governanca-operacio/21-seguretat-permisos-accessos.md`, `05-governanca-operacio/22-manual-operatiu-intern.md`, `05-governanca-operacio/23-annex-captures-pantalla.md` | Visibilitat, avisos, permisos i evidencies definits. Falta implementacio, prova executada i captura final. |
| Empresa/responsable | ESPECIFICACIO OPERATIVA | `03-canvis-pendents/07-pantalles-intranet.md`, `03-canvis-pendents/10-procediments-intranet-ecommerce.md`, `04-estat-final/16-estat-final-pantalles.md`, `05-governanca-operacio/20-pla-proves-validacio-sif.md`, `05-governanca-operacio/21-seguretat-permisos-accessos.md`, `05-governanca-operacio/22-manual-operatiu-intern.md`, `05-governanca-operacio/23-annex-captures-pantalla.md` | Cobertura, receptor fiscal, avisos, permisos i evidencies definits. Falta implementar el canal extern, executar proves i conservar captures. |
| Intranet tutor | DECISIO | `04-estat-final/16-estat-final-pantalles.md` | Confirmar que no te impacte fiscal. |

### 5.1. Tracabilitat operativa de pantalles internes

| Pantalla o vista | Procediment intern | Accio SIF principal | Prova minima | Captura minima |
|---|---|---|---|---|
| Passar pagaments | `10`, apartat Passar pagaments; `22`, comprovacions abans de confirmar | `registerPayment()` si ja existeix factura; `issueInvoice(payment)` si no existeix | `SIF-PANT-PAY-001` i `SIF-PANT-PAY-002` | Estat previ, decisio visible, avisos o bloquejos i resultat final |
| Generar factura abans de pagar | `10`, apartat Generar factura abans de pagar; `22`, comprovacions abans de confirmar | Emissio previa i posterior vinculacio del cobrament amb `registerPayment()` | `SIF-PANT-FAC-001` | Dades del receptor, resum fiscal, confirmacio i factura generada |
| Consulta - Edita - Anula factura | `10`, apartat Consulta - Edita - Anula; `22`, comprovacions abans de confirmar | Consulta; edicio nomes quan es admissible; anulacio o rectificacio amb traca | `SIF-PANT-FACT-001` i `SIF-PANT-FACT-002` | Estat, accions habilitades o bloquejades, motiu i resultat |
| Intranet alumne | `10`, apartat Intranet alumne; `21`, permisos | Consulta limitada a documents propis i avisos accionables | `SIF-VIS-002` | Vista amb dades personals anonimitzades i avisos visibles |
| Empresa/responsable | `10`, apartat Empresa/responsable; `21`, permisos; `22`, comprovacions | Consulta i operacio nomes sobre persones o inscripcions cobertes | `SIF-VIS-002` i proves de receptor o cobertura | Receptor fiscal, abast de cobertura, bloqueig o resultat |
| Indicadors i avisos VERI*FACTU | `07`, comportament dels avisos; `22`, interpretacio operativa | Classificacio com indicador, avis, notificacio o incidencia SIF | `SIF-AVI-001` i `SIF-AVI-002` | Missatge, severitat, accio requerida i estat posterior |
