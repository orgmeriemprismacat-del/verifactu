...
2. `Consulta - Edita - Anula factura`: subbloc especialitzat revisat; falta implementar rectificatives SIF, devolucions/saldo, cataleg de motius, bloqueig d'edicio directa i proves.
