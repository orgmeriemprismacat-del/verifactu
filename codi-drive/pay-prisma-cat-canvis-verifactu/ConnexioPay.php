...
/**
* @class ConnexioPay
* @brief Contó tota la informació relacionada amb la connexió a la base de dades DADES_FISCALS
*/
class ConnexioPay {
   ...
   */
   ...
   {
      include('parametres-connexio-factures.php'); //Fitxer que conté el user, password, server, dbname
