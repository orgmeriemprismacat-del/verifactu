...
function cursos_disponibles() {
	...
	var mes = $("#mesos").val();
	$.ajax({
		url: "https://old.prisma.cat/ajax/buscar_cursos_disponibles_revisions.php?&any="+any+"&mes="+mes+"&order=id_Curs",
		cache: false,
		type: "GET",
...
function ordenar_per_nom_curs() {
	...
	var mes = $("#mesos").val();
	$.ajax({
		url: "https://old.prisma.cat/ajax/buscar_cursos_disponibles_revisions.php?&any="+any+"&mes="+mes+"&order=NOM_CURS",
		cache: false,
		type: "GET",
		success: function(cursos) {
			$("#cursos").html(cursos);
...
function ordenar_per_tutor() {
	...
	var mes = $("#mesos").val();
	$.ajax({
		url: "https://old.prisma.cat/ajax/buscar_cursos_disponibles_revisions.php?&any="+any+"&mes="+mes+"&order=NOM, COGNOMS",
		cache: false,
		type: "GET",
		success: function(cursos) {
			$("#cursos").html(cursos);
