...
function anys_disponibles() {
	$.ajax({
		url: "https://old.prisma.cat/ajax/buscar_anys_disponibles.php?",
		cache: false,
		type: "GET",
...
function mesos_disponibles() {
	var any = $("#any").val();
	$.ajax({
		url: "https://old.prisma.cat/ajax/buscar_mesos_disponibles.php?&any="+any,
		cache: false,
		type: "GET",
...
function cursos_disponibles(hores) {
	...
	$.ajax({
		url: "https://old.prisma.cat/ajax/getcursos_campusnou_"+comunicat+".php?mes="+mes+"&any="+any+"&hores="+hores,
		cache: false,
		type: "GET",
