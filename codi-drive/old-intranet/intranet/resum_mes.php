...
<body topmargin="0">
	<table width="1100" align="center" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0" id="main">
        <tr>
          ...
          <?php
					...
					?>
                        ...
                        <div class="nav_on ppal_on">ADMINISTRACIÓ</div>
                        <div class="nav ppal"><a style="margin-left:1px;">SUPORT</a></div>
					<?php
					}
		...
		<!--<div class="nav2"><a href="resum_mes_sense_minim.php" style="margin-left:1px;"><span style="font-size:10px">RESUM</span><br />MES NO MINIM</a></div>
								...
								if(mysql_num_rows($result)>0)
								{
									...
									while ($c = mysql_fetch_array($result_cursos))
									{
										if ($row['CURS']==$c['CURS'])
										{
											...
											if ($c['id_cuho']<>17)
											{
												$result_despeses = mysql_query ("SELECT PERFIL, PREU_ALUMNE, CURS, id_cuho FROM honoraris AS h, rel_cuho AS r WHERE r.id_cuho=".$c['id_cuho']." AND r.id_hono=h.ID", $conexion);
