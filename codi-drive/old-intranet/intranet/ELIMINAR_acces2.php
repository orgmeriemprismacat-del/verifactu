...
if ($_POST["submit"]=="Accedir")
{
	if(($_POST["contrasenya"]<>"Contrasenya") && ($_POST["usuari"]<>"Usuari"))
	{
		...
		$link=Conectarse(); 
		$sql="select Nom, rol from intranet where usuari='".$_POST[usuari]."' and contrasenya='".$contrasenya_encriptada."' and (rol='facturacio' or rol='admin')";		
		...
		{ 
			...
			Header ("Location: ./facturacio/pagaments_pendents.php");
