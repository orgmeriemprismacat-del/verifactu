...
for ($n=0; $n<mysqli_num_rows($result_cursos); $n++) {
	...
	if ($row_revisio['finalitzat']!="") //s'ha revisat
	{
        ...
        else if ($row['HORES']==30 && $row['CURS']=="CANVA") {
			$estat_revisio = "<a href=\"https://old.prisma.cat/intranet/revisions/canva.php?shortname=".$shortname."\" target=\"_blank\">OBRIR</button>";
		}
        ...
        else if ($row['HORES']==40 && $row['CURS']=="ALBUM") {
			$estat_revisio = "<a href=\"https://old.prisma.cat/intranet/revisions/album.php?shortname=".$shortname."\" target=\"_blank\">OBRIR</button>";
		}
        else if ($row['HORES']==40 && $row['CURS']=="GUST") {
			$estat_revisio = "<a href=\"https://old.prisma.cat/intranet/revisions/gust.php?shortname=".$shortname."\" target=\"_blank\">OBRIR</button>";
		}
