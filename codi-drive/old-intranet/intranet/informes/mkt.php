...
// Mòdul 1 
$enunciat1="Descriure quin és el nou escenari i alhora posa de manifest per què és recomanable tenir nocions de màrqueting i comunicació aplicats a l’escola.";
$enunciat2="Explicar algunes de les premisses bàsiques que cal tenir en compte per emprendre el curs amb èxit.";

// Mòdul 2 
$enunciat3="Saber quina és la missió de la teva escola, és a dir, la vostra aportació útil a la societat.";
$enunciat4="Plasmar la missió per escrit seguint una sèrie de recomanacions.";
$enunciat5="Entendre què és la visió, així com els seus diferents nivells de temporalitat.";
$enunciat6="Qüestionar-te si el teu centre segueix una línia o una banda d’escola (depenent de com se sentin els membres de la comunitat educativa).";
$enunciat7="Comprendre la necessitat de ser flexibles davant del canvi en lloc de lluitar contra la contemporaneïtat.";

// Mòdul 3 
$enunciat8="Diferenciar entre característiques i beneficis i conèixer què és el que fa decantar la balança quan una família busca una escola per als seus fills.";
$enunciat9="Identificar quins són els beneficis nuclears de la teva escola partint de la descripció de les seves característiques i d’allò que s’hi fa.";
$enunciat10="Conèixer qui són els clients plus i la importància que tenen en l’elaboració del Pla d’Acció de Comunicació o Màrqueting.";
$enunciat11="Escriure una oferta única de venda que sintetitzi tot el contingut anterior.";
$enunciat12="Conèixer els avantatges de tenir per escrit la píndola de l’ascensor i redactar-ne dues.";

// Mòdul 4 
$enunciat13="Conèixer els criteris que has de tenir en compte a l’hora de començar a escriure el Pla d’Acció.";
$enunciat14="Identificar quins són els cinc requisits bàsics per poder comunicar les nostres accions a la resta de la comunitat.";
$enunciat15="Conèixer i concretar qui són els nostres clients plus i quina és la seva importància a l’hora d’incrementar la confiança i la matriculació en el centre.";
$enunciat16="Classificar les accions en diferents categories i saber quins són els ítems que han de constar en qualsevol acció comunicativa.";
$enunciat17="Obtenir un gran ventall d’accions comunicatives que et serviran d’exemple per a la redacció del Pla d’Acció";

// Mòdul 5
$enunciat18="Entendre quin és l’eix neuràlgic del Pla Boca-Orella i com s’aplica a diferents sectors.";
$enunciat19="Conèixer quins són els quatre passos necessaris per liderar converses positives envers el teu centre.";
$enunciat20="Saber com organitzar la informació per dur a terme el Pla Boca-Orella.";
$enunciat21="Pensar temes engrescadors per a les famílies, per al claustre, per a l’alumnat, i per a les empreses o institucions amb les quals l’escola manté una relació.";

// Mòdul 6 
$enunciat22="Recordar els punts més destacats de cada mòdul, així com els requisits per escriure cada una de les parts del Pla d’Acció.";
$enunciat23="Donar forma final al Pla d’Acció per convertir-lo en un document curt i fàcil d’aplicar a la teva realitat educativa.";
$enunciat24="Conèixer propostes de canvi en diferents àmbits de l’escola, que podràs utilitzar per comunicar la vostra visió de l’educació i la vostra missió.";

// Valoració segons el grau de participació i interacció dels participants a les diferents activitats per mòdul: 

// Mòdul 1 
$enunciat25="Grau de participació.";
$enunciat26="Grau d’interacció entre els participants.";

// Mòdul 2 
$enunciat27="Grau de participació.";
$enunciat28="Grau d’interacció entre els participants.";

// Mòdul 3
$enunciat29="Grau de participació.";
$enunciat30="Grau d’interacció entre els participants.";

// Mòdul 4 
$enunciat31="Grau de participació.";
$enunciat32="Grau d’interacció entre els participants.";
...
$enunciat37="Resposta dels participants al DEBAT 1.";
$enunciat38="Resposta dels participants al DEBAT 2.";
$enunciat39="Resposta dels participants al DEBAT 3.";
$enunciat40="Resposta dels participants al DEBAT 4.";
$enunciat41="Resposta dels participants al DEBAT 5.";
$enunciat42="Resposta dels participants al DEBAT 6.";
$enunciat43="Hi ha debats iniciats pels participants?";
$enunciat44="Hi ha recursos proposats pels participants en el RACÓ D'INTERCANVI?";
$enunciat45="Resposta dels participants en el P@SSADÍS.";
							...
							if (mysqli_num_rows($result)>0)
							{
							 ...
							 ?>                	
									...
									<tr class="borde_inferior">
										...
										<td align="center">                    		
											<input type="radio" name="preg37" value="C" <?php if ($cadena[37]=='C') {echo ('checked');} ?> disabled="disabled">
										</td>                     
										<td align="center">                    		
									...
									<tr class="borde_inferior">
										...
										<td align="center">                    		
											<input type="radio" name="preg38" value="C" <?php if ($cadena[38]=='C') {echo ('checked');} ?> disabled="disabled">
										</td>                     
										<td align="center">                    		
									...
									<tr class="borde_inferior">
										...
										<td align="center">                    		
											<input type="radio" name="preg39" value="C" <?php if ($cadena[39]=='C') {echo ('checked');} ?> disabled="disabled">
										</td>                     
										<td align="center">                    		
									...
									<tr class="borde_inferior">
										...
										<td align="center">                    		
											<input type="radio" name="preg40" value="C" <?php if ($cadena[40]=='C') {echo ('checked');} ?> disabled="disabled">
										</td>                     
										<td align="center">                    		
									...
									<tr class="borde_inferior">
										...
										<td align="center">                    		
											<input type="radio" name="preg41" value="C" <?php if ($cadena[41]=='C') {echo ('checked');} ?> disabled="disabled">
										</td>                     
										<td align="center">                    		
									...
									<tr class="borde_inferior">
										...
										<td align="center">                    		
											<input type="radio" name="preg43" value="si" <?php if ($cadena[43]=='si') {echo ('checked');} ?> disabled="disabled">
										</td>
										<td align="center">                    		
											NO
										</td>
										<td align="center">                    		
											<input type="radio" name="preg43" value="no" <?php if ($cadena[43]=='no') {echo ('checked');} ?> disabled="disabled">
										</td>                                                                                
									</tr>
									<tr class="borde_inferior">
										<td colspan="4">              		
										...
										<td align="center">                    		
											<input type="radio" name="preg44" value="si" <?php if ($cadena[44]=='si') {echo ('checked');} ?> disabled="disabled">
										</td>
										<td align="center">                    		
											NO
										</td>
										<td align="center">                    		
											<input type="radio" name="preg44" value="no" <?php if ($cadena[44]=='no') {echo ('checked');} ?> disabled="disabled">
										</td>                                                 
									</tr>
                                    <tr class="borde_inferior">
										<td colspan="2">                        		
