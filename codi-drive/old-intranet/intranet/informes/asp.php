...
// Mòdul 1 
$enunciat1="Conèixer i reflexionar sobre les dificultats de la SA en la comunicació no verbal i les seves conseqüències.";
$enunciat2="Conèixer i identificar la simptomatologia de la SA i treballar els criteris diagnòstics.";
$enunciat3="Reflexionar sobre la integració de la SA  en el grup-classe.";

// Mòdul 2 
$enunciat4="Prendre consciència de les dificultats en la detecció i identificació de l’alumnat amb SA.";
$enunciat5="Conèixer, reflexionar i analitzar el procés d’identificació i els aspectes a avaluar.";

// Mòdul 3 
$enunciat6="Conèixer les necessitats educatives dels alumnes amb la SA en les diferents etapes escolars.";
$enunciat7="Prendre consciència de la necessitat d'introduir canvis i millores en el rol docent per tal d'adequar la resposta educativa.";
$enunciat8="Adquirir orientacions per a treballar i adaptar el treball d’aula amb l’alumnat afectat per Síndrome d’Asperger.";

// Mòdul 4 
$enunciat9="Adquirir recursos i estratègies per a treballar i adaptar el treball d’aula amb l’alumnat afectat per Síndrome d’Asperger.";
$enunciat10="Reflexionar sobre els recursos de l’escola per atendre als alumnes amb la SA.";
...
$enunciat25="Resposta dels participants en el P@SSADÍS.";
