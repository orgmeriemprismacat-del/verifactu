...
// Mòdul 1
$enunciat1="Analitzar el concepte de professió docent.";
$enunciat2="Conèixer i valorar les competències i habilitats necessàries per exercir la docència.";
$enunciat3="Analitzar la importància del primer dia de feina.";

// Mòdul 2
$enunciat4="Definir el concepte de grup.";
$enunciat5="Analitzar les etapes per les que passa un grup.";
$enunciat6="Treballar les característiques del \"grup classe\".";
$enunciat7="Valorar la importància de les dinàmiques de grup com a elements de cohesió grupal.";
$enunciat8="Conèixer els diferents rols que es poden donar en un \"grup classe\".";
$enunciat9="Valorar la importància de la tutoria en els processos d’adquisició d’aprenentatges i d’evolució personal de l’alumnat.";
$enunciat10="Especificar els diferents tipus de tutoria que es poden portar a terme i quines són les seves característiques.";
$enunciat11="Analitzar les diferents tasques del tutor.";
$enunciat12="Reflexionar entorn a la importància del Pla d’Acció Tutorial i la seva relació amb el Projecte de Centre
.";


// Mòdul 3
$enunciat13="Analitzar la importància de la relació família-escola.";
$enunciat14="Conèixer tipologies o estereotips de famílies.";
$enunciat15="Valorar la importància de les reunions amb les famílies del \"grup classe\" com a elements de comunicació i relació entre elles i el centre educatiu.";
$enunciat16="Conèixer les qüestions pràctiques que s’han de tenir en compte quan s’organitza qualsevol reunió.";
$enunciat17="Aprendre estratègies per afrontar una reunió amb les famílies quan es tenen problemes per parlar en públic.";
$enunciat18="Valorar la importància de les reunions individuals amb les famílies.";
$enunciat19="Aprendre estratègies per preparar una entrevista d’èxit amb les famílies.";
$enunciat20="Analitzar les entrevistes individuals amb les famílies, la seva evolució i avaluació.";
$enunciat21="Referenciar la importància de les teories cognitives en els processos d’aprenentatge.";
$enunciat22="Analitzar diferents metodologies d’aprenentatge i la seva idoneïtat per treballar la diversitat dins l’aula.";
