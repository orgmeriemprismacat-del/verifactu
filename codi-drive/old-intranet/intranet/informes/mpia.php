							 ...
							 ?>
									...
									<tr>
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="cadena[26]" value="C" <?php if ($cadena[26]=='C') {echo ('checked');} ?> disabled="disabled">
											</td>
                                            <td align="center">
												<input type="radio" name="cadena[26]" value="0" <?php if ($cadena[26]=='0') {echo ('checked');} ?> disabled="disabled">
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="1" <?php if ($cadena[26]=='1') {echo ('checked');} ?> disabled="disabled">
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="2" <?php if ($cadena[26]=='2') {echo ('checked');} ?> disabled="disabled">
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="3" <?php if ($cadena[26]=='3') {echo ('checked');} ?> disabled="disabled">
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="4" <?php if ($cadena[26]=='4') {echo ('checked');} ?> disabled="disabled">
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="5" <?php if ($cadena[26]=='5') {echo ('checked');} ?> disabled="disabled">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
