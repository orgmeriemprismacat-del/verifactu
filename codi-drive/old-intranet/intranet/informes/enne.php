...
// Mòdul 1 
$enunciat1="Conèixer els orígens de l’enneagrama i la seva evolució fins als nostres dies.";
$enunciat2="Presentar i treballar el símbol de l’enneagrama.";
$enunciat3="Estudiar les tríades com a primers grans grups de classificació dels enneatipus.";
$enunciat4="Aprendre les relacions que tenen els enneatipus entre sí.";
$enunciat5="Descobrir el camí de creixement i deteriorament de cada enneatipus.";

// Mòdul 2 
$enunciat6="Conèixer i treballar les característiques generals de cada enneatipus (professorat, alumnat).";
$enunciat7="Oferir exemples de cada un dels diferents enneatipus relacionant-los amb l’entorn educatiu (professorat, alumnat).";
$enunciat8="Conèixer què és convenient que treballi cada enneatipus en el seu camí de creixement personal i professional.";

// Mòdul 3 
$enunciat9="Reflexionar entorn dels valors i creences de cadascun dels enneatipus dels docents i alumnes.";
$enunciat10="Treballar la relació amb el temps personal i compartit de cadascun dels enneatipus.";
$enunciat11="Conèixer estratègies per generar relacions positives entre els diferents enneatipus.";
$enunciat12="La relació dels diferents enneatipus amb el treball.";

// Mòdul 4 
$enunciat13="Analitzar la relació dels diferents enneatipus amb el treball.";
$enunciat14="Estudiar la manera de comunicar-se de cadascun dels enneatipus.";
$enunciat15="Reflexionar sobre els diferents tipus de conflictes que es poden presentar en un centre educatiu.";
$enunciat16="Treballar les característiques generals dels tres estils prioritaris per abordar un conflicte segons l’enneatipus.";
$enunciat17="Conèixer els diferents tipus de motivació i estudiar com els valors i les creences influeixen de manera directa en la nostra manera de motivar-nos.";
$enunciat18="Conèixer els diferents tipus de motivació en els entorns educatius i la seva relació amb els enneatipus.";
...
$enunciat30="Resposta dels participants al DEBAT 4.";
$enunciat31="Hi ha debats iniciats pels participants?";
$enunciat32="Hi ha recursos proposats pels participants en el RACÓ D'INTERCANVI?";
$enunciat33="Resposta dels participants en el P@SSADÍS.";
							...
							if (mysqli_num_rows($result)>0)
							{
							 ...
							 ?>                	
										...
										<table border="0" align="center" width="100%" vspace="0" cellpadding="0" cellspacing="0" class="taula">   
                                            ...
                                            <tr class="apartat">
												<td colspan="2">
													ANÀLISI DE LES EXPECTATIVES (fòrum PRESENTACIÓ I EXPECTATIVES)                            
												</td>
											</tr>
											<tr>
									...
									<tr>
										<td class="celda2" colspan="7">
											<p><strong class="fort2">VALORACIÓ SEGONS ELS CONTINGUTS DE CADA MÒDUL:</strong></p>
										</td>
									</tr>	
                                    <tr>
                                    	<td colspan="7" class="modul">
                                        
                                        </td>
                                    </tr>
									<tr>
										<td width="780" class="apartat2">
									...
									?>
									<tr>
										<td class="celda" colspan="7" align="center">	
