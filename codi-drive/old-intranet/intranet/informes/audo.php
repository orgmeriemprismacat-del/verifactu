...
// Mòdul 1 
$enunciat1="Animar-se a conduir el timó de la pròpia vida.";
$enunciat2="Prendre decisions pròpies i responsables vers la vida professional i personal.";
$enunciat3="Comprendre que la “realitat” es pot veure des d’un punt de vista més o menys objectiu.";
$enunciat4="Interioritzar les pautes de treball que se seguiran als mòduls següents.";

// Mòdul 2 
$enunciat5="Entendre la realitat tal com és.";
$enunciat6="Comprendre que la realitat que vivim necessita ser observada, sense manipulacions.";
$enunciat7="Aprendre a detectar els errors que succeeixen a la nostra vida professional.";
$enunciat8="Empoderar-se en la vida professional.";
$enunciat9="Gaudir de la tasca docent.";

// Mòdul 3 
$enunciat10="Fer una mirada comprensiva al propi infant intern.";
$enunciat11="Aprendre a veure en cada alumne/a el millor d’ell/a mateix/a.";
$enunciat12="Proporcionar l’ajuda i el suport que cada nen/a necessita.";
$enunciat13="Comprendre i respectar les emocions dels infants i adolescents.";

// Mòdul 4 
$enunciat14="Comprendre que el mal no existeix.";
$enunciat15="Entendre que tothom, des del seu punt de vista, té raó.";
$enunciat16="Aprendre que podem escollir la forma com actuem davant la conducta aliena.";

// Mòdul 5
$enunciat17="Vincular-se de forma sana amb els alumnes, les seves famílies, els integrants del claustre i el personal no docent del propi centre.";
$enunciat18="Saber estimar i donar suport als alumnes, famílies, companys i personal no docent, més enllà de les nostres preferències personals i els nostres valors.";
$enunciat19="Posar-se al servei dels alumnes i les famílies sense judicis i amb efectivitat.";
$enunciat20="Valorar el treball en equip amb els nostres companys de claustre i el personal no docent del propi centre.";

// Mòdul 6 
$enunciat21="Comprendre que tenim la possibilitat de canviar conductes i creences per acostar-nos més efectivament als nostres objectius professionals i personals.";
$enunciat22="Adoptar accions concretes per millorar la pròpia vida professional i personal.";
$enunciat23="Incorporar canvis realistes a la pròpia vida que la transformin de forma útil en el camp professional i personal.";
$enunciat24="Obtenir més comprensió, amor i energia en aspectes importants de la pròpia vida professional i personal.";
