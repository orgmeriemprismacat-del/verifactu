<?php
   ...
   if ( $enviat || $enviatAntic ) {
      ...
      if ( $hores == '30')
         ...
         $apartats = [ [ "BÀNERS TUTORIES", 2 ], ["APARTAT GENERAL", 4], ["MÒDUL 1", 5], ["MÒDUL 2", 5], ["MÒDUL 3", 5], ["MÒDUL 4", 5], ["MÒDUL 5", 5], ["JA HEM ARRIBAT AL FINAL", 1]];
	   else if ( $hores == '60')
         ...
         $apartats = [ [ "BÀNERS TUTORIES", 2 ], ["APARTAT GENERAL", 4], ["MÒDUL 1", 4], ["MÒDUL 2", 4], ["MÒDUL 3", 4], ["MÒDUL 4", 4], ["JA HEM ARRIBAT AL FINAL", 1]];
      else if ( $hores == 'eines')
