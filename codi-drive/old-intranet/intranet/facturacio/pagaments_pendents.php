										...
										?>
											...
											<td scope="col">
												...
												if (url_exists("https://campus.prisma.cat/intranet-collaboradors/cobraments/factures/".$any_gestio_cobrament.$mes_gestio_cobrament."_Curs_".$row['ANY'].$row['CURS'].$row['MES']."_".$rol_llarg."_".$nom_tutor.".pdf"))
													echo "<a href=\"".$file."\" target=\"_blank\"><img src=\"https://old.prisma.cat/intranet/img/pdf.png\" alt=\"Imatge pdf\" /></a>";								
												else
													echo "<img src=\"https://old.prisma.cat/intranet/img/creu.png\" alt=\"Imatge creu\" />";
