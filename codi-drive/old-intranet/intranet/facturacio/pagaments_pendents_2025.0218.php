		 ...
		 <a title='TikTok' name='TikTok' href='https://www.tiktok.com/@prisma.educacio' target='_blank' style='text-decoration: none!important;'>
		  <img border='0' style='height: 25px;' src='https://www.prisma.cat/img/social/firma/tiktok.png'>
								...
								if(mysqli_num_rows($result)>0)
								{
									...
									?>
										...
										?>
											...
											<td scope="col">
												...
												if (
													(
														$any_gestio_cobrament > 2023
														||
														(
															$any_gestio_cobrament == 2023
															&&
															( $mes_gestio_cobrament == '09' || $mes_gestio_cobrament == '10' || $mes_gestio_cobrament == '11' || $mes_gestio_cobrament == '12' )
														)
													)
													&& 
													$nom_tutor != "Zazil" && $nom_tutor != "Daniel_Gabarro" && $nom_tutor != "Ads_escola" && $nom_tutor != "AESH"
												)
												...
												target=\"_blank\"><img src=\"https://www.prisma.cat/intranet/facturacio/pdf.png\" alt=\"Imatge pdf\" /></a></td>" ;
												else
									...
									Prioritat de pagament (segons data de finalització del curs): <img src="../img/grey.png" border="0" style="vertical-align: middle; padding-left:10px;" /> <strong>normal</strong> (entre 20 i 24 dies) <img src="../img/green.png" border="0" style="vertical-align: middle; padding-left:20px;" /> <strong>alta</strong> (entre 25 i 29 dies)<img src="../img/red.png" border="0" style="vertical-align: middle; padding-left:20px;" /> <strong>urgent</strong> (a partir de 30 dies)
									<br /><br />Ordenar per:
									&nbsp;
