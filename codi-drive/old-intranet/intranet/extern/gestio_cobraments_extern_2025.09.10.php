<?php
  ...
  if(isset($_SESSION['usuari']) && isset($_SESSION['contrasenya_encriptada']))
  {
    ...
    // els dni es passen des del fitxer acces_extern.php
  	if ($_SESSION['usuari']=="G17843830" or $_SESSION['usuari']=="G67253443") //Poso com a dni el de l'empresa d'ADS, el dni de la Laura, de l'Ester i de la Carme
  		$dni = 	$_SESSION['usuari']."' OR c.DNI_TUTOR LIKE '43674436N' OR c.DNI_TUTOR LIKE '79302336S' OR c.DNI_TUTOR LIKE '52194953H' OR c.DNI_TUTOR LIKE '40873976D";
                ...
                <?php
                  ...
                  else if ($_POST['gestiook']=="S")
                  {
                    ...
                    if ($_POST[gestio."$_POST[num]"]=="GESTIONAR")
                    {
                      ...
                      {
          					  	if ($_SESSION['usuari'] == "G17843830" or $_SESSION['usuari']=="G67253443") {

      							       $result = mysqli_query ($connexio,"SELECT c.CURS, c.MES, c.ANY, `NOM CURS` AS titol, AULA, Data_llarga_Inici, Data_llarga_Fin, data_informe, DNI_TUTOR, id_cuho, SUM(CASE WHEN (`INSC CURS` = '1') THEN 1 ELSE 0 END) inscrits FROM cursos AS c, inscripcions AS i WHERE (DNI_TUTOR LIKE '43674436N' OR DNI_TUTOR LIKE '79302336S' OR DNI_TUTOR LIKE '40873976D') and c.CURS='".$_POST[curs_tut."$n"]."' AND c.ANY=".$_POST[any_tut."$n"]." AND c.MES='".$_POST[mes_tut."$n"]."' AND pagat='N' AND c.CURS=i.CURS AND c.ANY=i.ANY AND c.MES=i.MES AND AULA=Grup GROUP BY Grup");
                             }
          						  else
                      ...
                      else // mostrem les dades del curs a gestionar
                      {
                        ...
                        if ($curs == "SIST" && $_SESSION['usuari']!="77897279M") //cas AD'S.
                          ...
                          if ($any > 2019 || ($any==2019 && ($mes=='09' or $mes=='10' or $mes=='11' or $mes=='12'))) {
            						...
            						{
            							echo "DNI es session<br>";$dni2=$_SESSION['usuari'];
            						}
                  ...
                  else
                  {
                    ...
                    else
                    {
                       $dni_tutor_username=$_SESSION['usuari'];
          						...
          						if ($_SESSION['usuari']=="G17843830" or $_SESSION['usuari']=="G67253443") {//Poso com a dni el de l'empresa d'ADS, el dni de la Laura, l'Ester i la Carme
          							if (date(Y) > 2019 || (date(Y)==2019 && date(n)>=9) ) {
          								$dni_tutor_username2 = 	"G67253443' OR h.DNI_TUTOR LIKE '43674436N' OR h.DNI_TUTOR LIKE '79302336S' OR h.DNI_TUTOR LIKE '40873976D";
          								$dni_tutor_username= 'G67253443';
          							}
          							else {
          								$dni_tutor_username2 = 	"G17843830' OR h.DNI_TUTOR LIKE '43674436N' OR h.DNI_TUTOR LIKE '79302336S' OR h.DNI_TUTOR LIKE '40873976D";
