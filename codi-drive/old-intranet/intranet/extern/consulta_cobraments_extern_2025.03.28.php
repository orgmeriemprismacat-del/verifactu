...
{
	if ($_SESSION['usuari']=="G17843830") //Poso com a dni el de l'empresa d'ADS, el dni de la Laura, de l'Ester i de la Carme
		$dni = 	$_SESSION['usuari']."' OR DNI_TUTOR LIKE '43674436N' OR DNI_TUTOR LIKE '79302336S OR DNI_TUTOR LIKE '52194953H' OR c.DNI_TUTOR LIKE '40873976D";
	if ($_SESSION['usuari']=="43400030L") //Si és el Daniel, poso com a dni el de'n Daniel i el de l'empresa Boira
		$dni = 	$_SESSION['usuari']."' OR DNI_TUTOR LIKE 'B25750407";
	if ($_SESSION['usuari']=="39352558H" or $_SESSION['usuari']=="B87456992" or $_SESSION['usuari']=="77897279M") //Si és la Neus o el FB, poso com a dni el seu.
		$dni = 	$_SESSION['usuari'];
	/* ----------------------------------------------------------------------------------------------------------------------------------*/
	$idioma = "ca";
