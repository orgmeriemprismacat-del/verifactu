...
// Mòdul 1
$enunciat1="Reflexionar sobre la dimensió pedagògica de les TIC.";
$enunciat2="Conèixer i reflexionar sobre les potencialitats de les TIC i també sobre les seves limitacions.";
$enunciat3="Aprendre quines són les fortaleses i febleses de la formació mediada per les TIC.";
$enunciat4="Adquirir una visió general sobre les característiques dels diferents entorns en línia.";
$enunciat5="Familiaritzar-nos amb les modalitats de formació <em>e-learning</em> i <em>b-learning</em>.";

// Mòdul 2
$enunciat6="Conèixer les diferents competències del docent dins d’un entorn en línia.";
$enunciat7="Identificar les variables i elements que condicionen la docència i la seva planificació en entorns en línia o semipresencials.";
$enunciat8="Identificar les característiques més rellevants sobre la comunicació i la interacció en el procés d’ensenyament-aprenentatge en línia.";
$enunciat9="Reflexionar sobre la importància de l’acompanyament en els entorns en línia.";
$enunciat10="Familiaritzar-nos amb les funcions i tasques principals del docent en línia.";
$enunciat11="Conèixer els diferents rols del docent en línia.";

// Mòdul 3
$enunciat12="Identificar els principals elements que condicionen el disseny i planificació de la docència en línia i semipresencial.";
$enunciat13="Aprendre a planificar el disseny d’activitats d’aprenentatge per a entorns en línia que fomentin la interacció, la participació i la col·laboració dels participants.";
$enunciat14="Aprendre a planificar les estratègies i recursos per a l’avaluació de situacions específiques d’aprenentatge en línia.";
$enunciat15="Identificar els principals elements i variables que influeixen en la planificació de la docència en es treballs col·laboratius en línia.";
$enunciat16="Comunicar-se i intercanviar coneixements en els entorns en línia.";
$enunciat17="Conèixer i utilitzar estratègies de treball en col·laboració en els entorns en línia.";
$enunciat18="Aprendre a dissenyar i planificar el treball en col·laboració en els entorns en línia.";
$enunciat19="Conèixer i utilitzar estratègies d’avaluació (autoavaluació i la coavaluació).";
$enunciat20="Adquirir eines i recursos relacionats amb el disseny i planificació de la docència en línia.";
...
$enunciat27="Resposta dels participants al DEBAT 1.";
$enunciat28="Resposta dels participants al DEBAT 2.";
$enunciat29="Resposta dels participants al DEBAT 3.";
							 ...
							 ?>
								...
								<td align="center">
									...
									<tr class="borde_inferior">
										...
										<td align="center">
											<input type="radio" name="preg27" value="C" <?php if ($cadena[27]=='C') {echo ('checked');} ?>>
										</td>
													  <td align="center">
									...
									<tr class="borde_inferior">
										...
										<td align="center">
											<input type="radio" name="preg28" value="C" <?php if ($cadena[28]=='C') {echo ('checked');} ?>>
										</td>
													  <td align="center">
									...
									<tr class="borde_inferior">
										...
										<td align="center">
											<input type="radio" name="preg29" value="C" <?php if ($cadena[29]=='C') {echo ('checked');} ?>>
										</td>
													  <td align="center">
									...
									<tr class="borde_inferior">
										...
										<td align="center">
											<input type="radio" name="preg30" value="si" <?php if ($cadena[30]=='si') {echo ('checked');} ?>>
										</td>
										<td align="center">
											NO
										</td>
										<td align="center">
											<input type="radio" name="preg30" value="no" <?php if ($cadena[30]=='no') {echo ('checked');} ?>>
										</td>
									</tr>
									<tr>
										<td colspan="4">
										...
										<td align="center">
											<input type="radio" name="preg31" value="si" <?php if ($cadena[31]=='si') {echo ('checked');} ?>>
										</td>
										<td align="center">
											NO
										</td>
										<td align="center">
											<input type="radio" name="preg31" value="no" <?php if ($cadena[31]=='no') {echo ('checked');} ?>>
										</td>
									</tr>
									<tr>
										<td colspan="8">&nbsp;
