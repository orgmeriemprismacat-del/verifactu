            ...
            <td align="center">
                <div id="login">
                    ...
                    <?php
						...
						$conexion_suma2 = mysqli_connect('localhost','historic','g$QPw#sKd@AHVB+JJ9Wv-mH54','historic');
						...
						else
						{
							...
							$result_suma_sl = mysqli_query ($conexion_suma2,"SELECT SUM(CASE WHEN (t.data_pagament = subdate(current_date, 1)) THEN t.import ELSE 0 END) SL from factures_sl AS t");
