  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      $.getJSON("/json/trobada_"+pathNom+".jsonld",function(data){$("<script/>",{"type":"application/ld+json",html:JSON.stringify(data)}).appendTo("head");});
   </script>
</head>
<body class="index">
   <header></header>
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/trobada.min.css?ver=5.1' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarTrobada.min.js?ver=10.0"></script>
