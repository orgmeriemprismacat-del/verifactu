  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      if (vectPath[2]) pathNom="/json/jornades"+vectPath[2]+".jsonld";
      else pathNom="/json/jornades.jsonld";
...
<body class="index">
   ...
   <div id="contingut" class="prisma-container" role="main"></div>
   ...
   <script async>
      ...
      var footerCSS = "<link rel='stylesheet' href='https://www.prisma.cat/css1619773569/footer.min.css?ver=5.2' />";
      $('head').append(headerCSS);
      $('head').append(footerCSS);
   </script>
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/jornades.min.css?ver=5.0' />
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/blocTrobada.min.css?ver=5.0' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarJornades.min.js?ver=6.0"></script>
