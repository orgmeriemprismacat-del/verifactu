  ...
  function consentGrantedAnalyticsStorage() {
    ...
    gtag('consent', 'update', {
      'analytics_storage': 'granted'
		...
		<script>
			$.getJSON("/json/perfil.jsonld",function(data){$("<script/>",{"type":"application/ld+json",html:JSON.stringify(data)}).appendTo("head");});
		</script>
	</head>
	<body class="index">
		<header></header>
   ...
   <script async>
      ...
      <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/pagina.min.css?ver=2.0' />
      <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/info_cdd.min.css?ver=2.1' />
		<script async src="https://www.prisma.cat/js1619773569/mostrarInfoCDD.min.js?ver=3.0"></script>
