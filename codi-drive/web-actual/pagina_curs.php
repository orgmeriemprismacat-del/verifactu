...
<script>
  ...
  function consentGrantedAnalyticsStorage() {
    ...
    renderJsonLd($_SERVER['DOCUMENT_ROOT']."/json/cursos/$slug.jsonld");
    renderJsonLd($_SERVER['DOCUMENT_ROOT']."/json/faqs/$slug.jsonld");
  ?>
...
<body class="index">
   ...
   <script async src="https://www.prisma.cat/js1619773569/mostrarCurs.min.js?ver=9.0"></script>
   <script defer src="https://www.prisma.cat/js1619773569/mostrarCursPostLoad.min.js?ver=9.0"></script>
