...
<script>
  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/header.min.css?ver=5.2' />
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/header.min.css?ver=5.2' />
   <script>
      let pathNom = "/json/pagemn_regal_curs.jsonld";
...
<body class="index">
   ...
   <div id="cnt-pagament-regal" class="prisma-container container separacio-peu" role="main">Pagament regal</div>
   <footer class="prisma-footer"></footer>
   <script async>
	   var headerCSS = "";
	   if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
	   	headerCSS += "<link rel='stylesheet' href='https://www.prisma.cat/css1619773569/header.min.css?ver=5.2' />";
	   }
	   else {
		   ...
		   headerCSS += "<link rel='stylesheet' media='screen and (max-width: 768px)' href='https://www.prisma.cat/css1619773569/header.min.css?ver=5.2' />";
	   }
   ...
   <script async src="https://www.prisma.cat/js1619773569/mostrarPagamentRegalProva.min.js?ver=2.0"></script>
