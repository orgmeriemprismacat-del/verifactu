  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      if (vectPath[2]) pathNom="/json/regal_curs_"+vectPath[2]+".jsonld";
      else pathNom="/json/regal_curs.jsonld";
...
<body class="index">
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/regal.min.css?ver=1.4' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarRegal.min.js?ver=7.1"></script>
