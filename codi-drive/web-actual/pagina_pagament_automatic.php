...
<script>
  ...
  function consentGrantedAnalyticsStorage() {
	...
	<body class="index">
		...
		<div id='cnt-pagament-inscripcio' class="prisma-container container separacio-peu" role="main"></div>
		...
		<script async src="https://www.prisma.cat/js1619773569/mostrarPagamentAutomatic.min.js?ver=6.0"></script>
