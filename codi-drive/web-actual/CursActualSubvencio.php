...
class CursActual {
   ...
   */
   public function mostrarCursPerfil() {
      ...
      <div class='mb-2 mt-1'>".$etiquetaNou.$etiquetaDesc."
      <a role='link' target='_self' class='color-text' href='".$linkCurs."' ";
      $mostrar.="title=\"Informació del curs de PrisMa «".$titol."»\">";

      $mostrar.="<h4 class='font-weight-bold my-0'>".$titol."</h4></a></div>";
      ...
      $mostrar.="<div class='col-12 col-md-4 prisma-perfil-overlay p-0'>
   ...
   /**
   * @brief Mostra la informació d'un curs (pestanya CDD)
   * @return Mostra la informació d'un curs a la pestanya d'un cdd
   */
   public function mostrarCursCDD() {
      $linkUrl=$this->obtenirUrl()->obtenirLink();
      ...
      $linkCDD="https://www.prisma.cat/competencia-digital/".$extUrl."";
      $linkImg="https://www.prisma.cat".$this->obtenirImgPerfil()->obtenirLink();
      $shortDesc=$this->obtenirShortDesc()->obtenirText();
      $dscImg=$this->obtenirImgPerfil()->obtenirAlt();
      $titol=$this->obtenirTitol()->obtenirText();
      ...
      $etiquetaNou=$this->__etiquetaCursNou();
      $etiquetaCDD=$this->__etiquetaCDD2Nivell();

      $etiquetes = $etiquetaCDD.$etiquetaSubvComplet.$etiquetaNou.$etiquetaDesc;
      ...
      $mostrar.="<div class='curs-cdd-container d-flex flex-column flex-md-row border-radius-2 mb-4'>
      <div class='col-12 col-md-8 curs-cdd pt-2 pr-2 pb-1 pl-3'>
      <div class='mb-2 mt-1'>".$etiquetes."
      <a role='link' target='_self' class='color-text' href='".$linkCurs."' ";
      $mostrar.="title=\"Informació del curs de PrisMa «".$titol."»\">";
      ...
      if ( $this->perfil != null ) {
        $mostrar .= "<div class='element mr-3'><i class='fas fa-tag mr-2'></i>";
      ...
      $mostrar.="<a role='link' class='consulta-edicions font-weight-normal' ";
      $mostrar.="title=\"Totes les edicions que acrediten algun cdd del curs de ";
      $mostrar.="PrisMa «".$titol."»\" href=\"".$linkCDD."\">Consulta les edicions</a>";
      $mostrar.="</div></div>";

      $mostrar.="<div class='col-12 col-md-4 prisma-cdd-overlay p-0'>
      <img role='img' src='".$linkImg."' alt=\"".$dscImg."\" class='h-100 w-100 ".$classeImatgeGran."'";

      if ($this->dispositiu=='ordinador') {
         $mostrar.="onclick=\"mostrarTaset('".$codiCursMin."')\">";
         $mostrar.="<div class='prisma-cdd-middle position-absolute'>";
         $mostrar.="<button role='button' id='boto_veure_tastet_".$codiCursMin."' ";
         $mostrar.="class='negreta500 border-radius-2' aria-label=\"Mostra tastet ".$titol."\" ";
         $mostrar.="type='button' data-html='true' title=\"Tastet del curs ".$titol."\" ";
         $mostrar.="onclick=\"mostrarTaset('".$codiCursMin."')\" data-placement='bottom' ";
   ...
   /**
   * @brief Mostra la informació d'un curs (pestanya subvencionats)
   * @return Mostra la informació d'un curs a la pestanya d'un cdd
   */
   public function mostrarCursSubvencionat() {
      $linkUrl=$this->obtenirUrl()->obtenirLink();
      ...
      $linkSubv="https://www.prisma.cat/cursos-subvencionats/".$extUrl."";
      $linkImg="https://www.prisma.cat".$this->obtenirImgPerfil()->obtenirLink();
      $shortDesc=$this->obtenirShortDesc()->obtenirText();
      $dscImg=$this->obtenirImgPerfil()->obtenirAlt();
      $titol=$this->obtenirTitol()->obtenirText();
      ...
      $etiquetaSubvComplet=$this->__etiquetaCursPlacesExhauridesSubvencionat();
      $etiquetaCDD=$this->__etiquetaCDD2Nivell();
      $etiquetes = $etiquetaCDD.$etiquetaSubvComplet;
      ...
      $mostrar.="<div class='curs-sub-container d-flex flex-column flex-md-row border-radius-2 mb-4'>
      <div class='col-12 col-md-8 curs-sub pt-2 pr-2 pb-1 pl-3'>
      <div class='mb-2 mt-1'>".$etiquetes."
      <a role='link' target='_self' class='color-text' href='".$linkCurs."' ";
      $mostrar.="title=\"Informació del curs de PrisMa «".$titol."»\">";
      $mostrar.="<h4 class='font-weight-bold my-0'>".$titol."</h4></a></div>";
   ...
   * @return Si el curs te CDD, mostra la etiqueta de «CDD» en format  etiqueta NOU
   */
   protected function __etiquetaCDD2Nivell() {
      $etiqueta = '';
      if ( $this->esCDD() ) {
         $objTxt = new Text("CDD");
         $txt = $objTxt->obtenirTextHTML();
