...
<script>
  ...
  function consentGrantedAnalyticsStorage() {
	...
	<body class="index">
		...
		<div id='cnt-pagament-grup' class="prisma-container container separacio-peu" role="main"></div>
		...
		<script async src="https://www.prisma.cat/js1619773569/mostrarConfirmacioPagamentGrupAutomatic.min.js?ver=2.0"></script>
