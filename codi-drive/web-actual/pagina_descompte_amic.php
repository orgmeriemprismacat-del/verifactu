  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      if (vectPath[2]) pathNom="/json/descompte_amic.jsonld";
      else pathNom="/json/descompte_amic.jsonld";
...
<body class="index">
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/descompte-amic.min.css?ver=1.2' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarDescompteAmic.min.js?ver=2.0"></script>
