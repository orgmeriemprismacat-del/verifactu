  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      $.getJSON("/json/tastet_"+pathNom+".jsonld",function(data){$("<script/>",{"type":"application/ld+json",html:JSON.stringify(data)}).appendTo("head");});
   </script>
</head>
<body class="index">
   <header></header>
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/tastet.min.css?ver=1.2' />
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/bescanvia.min.css?ver=1.0' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarTastet.min.js?ver=2.0"></script>
