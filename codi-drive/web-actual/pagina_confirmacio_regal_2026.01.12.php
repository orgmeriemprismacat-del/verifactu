...
<body class="index">
   ...
   <div id="contingut" class="prisma-container container separacio-peu" role="main">Confirmació pagament</div>
   ...
   <script async src="https://www.prisma.cat/js1619773569/mostrarConfirmacioRegal.min.js?ver=2.0"></script>
