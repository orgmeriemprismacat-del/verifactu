...
var reqEdicions = $.ajax({
	url: "https://www.prisma.cat/ajax/consultaEdicionsEscolaEstiu.php",
	method: "GET",
	dataType: "html"
});
...
var reqTitolFiltres = $.ajax({
	async: !0,
	url: "https://www.prisma.cat/ajax/mostrar_titol_filtres_cursos_escola_estiu.php",
	method: "GET",
	dataType: "html"
});
...
function mostrarBlocCursos() {
	...
	var reqBlocCursos = $.ajax({
		url: "https://www.prisma.cat/ajax/mostrar_cursos_escola_estiu.php",
		method: "GET",
		data: {
			filtres : JSON.stringify(filtres),
	...
	reqBlocCursos.done(function( cursos ) {
		...
		amagarLoadingModal();
		mostrarTextCapcalera('frase-cursos-escola-estiu');
