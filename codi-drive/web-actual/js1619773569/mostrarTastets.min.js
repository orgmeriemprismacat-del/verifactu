...
function mostrarPagina() {
	var requestPage  = $.ajax({
		async: !0,
		url: "https://www.prisma.cat/ajax/mostrar_pagina_tastets.php",
		method: "GET",
...
function mostrarTastet(urlTastet) {
	pathUrlTastet = "https://www.prisma.cat"+urlTastet;
	window.location.href = pathUrlTastet;
}
