...
function mostrarTotsSortejos() {
	var reqPage = $.ajax({
		url: domain + "ajax/mostrar_pagina_sortejos.php",
		method: "GET",
		data: {
	...
	reqPage.done(function( sortejos ) {
		$("#contingut_sortejos").html(sortejos);
		//mostrarDataActualitzacio();
		mostrarConcursVigent();
		mostrarPeguntesFrequentsSortejos();
	});
...
/*function mostrarTaset(codi) {
	if (!$('#veure_tastet_'+codi)[0]) {
		...
		reqTastet.done(function( tastet ) {
			$("#contingut_sortejos").append(tastet);
...
function mostrarConcursVigent() {
		var req = $.ajax({
			url: domain + "ajax/mostrar_sortejos_vigents.php",
			method: "GET",
			data: {
				dispositiu : dispositiu
			},
		...
		req.done(function( sortejos ) {
			$("#sortejos").html(sortejos);
		});
...
function mostrarPeguntesFrequentsSortejos() {
	var req = $.ajax({
		url: domain + "ajax/mostrar_preguntes_sortejos.php",
		method: "GET",
		data: {
			dispositiu : dispositiu
		},
