...
function mostrarConfirmacioInscripcio() {
	$.ajax({
		url: path + "ajax/mostrar_confirmacio_inscripcio.php?keyEncr=" + keyEncr,
		cache: false,
		type: "GET",
		success: function(confirmacio) {
			$("#cnt-inscripcio").html(confirmacio);
...
function afegirCSS() {
	$('body').append("<link rel='stylesheet' href='" + path + "css1600335587/confirmacioInscripcio.min.css' />");
	...
	$('body').append("<link rel='stylesheet' href='" + path + "css1600335587/font-awesome-prisma.min.css' />");
	$('body').append("<link rel='shortcut icon' type='image/x-icon' href='https://www.prisma.cat/favicon.ico'/>");
	$('body').append("<link rel='stylesheet' href='" + path + "css1600335587/404.min.css' />")
}
afegirCSS();
