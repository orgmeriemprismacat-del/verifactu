...
function mostrarConfirmacioRegal() {
	$.ajax({
		url: "https://www.prisma.cat/ajax/mostrar_confirmacio_regal_pagament_automatic.php?keyEncr=" + keyEncr,
		cache: false,
		type: "GET",
		success: function(confirmacio) {
			$("#contingut").html(confirmacio);
...
function mostrarDocumentacio(id) {
	...
	input += "align-items-center px-2 position-absolute text-center text-white'></span>";
	input += "</div>";
