...
function mostrarPagina() {
	var reqPage = $.ajax({
		url: domain + "ajax/mostrar_pagina.php",
		method: "GET",
		data: {
			url : urlPagina,
	...
	reqPage.done(function( pagina ) {
		$("#pagina").html(pagina);
		if (urlPagina == "/activitats-formacio-interes-serveis-socials") {
			mostrarFiss()
		} else if (urlPagina == "/preguntes-frequents") {
			mostrarFaqs()
		}
...
function mostrarFiss() {
		var req = $.ajax({
			url: domain + "ajax/mostrar_cursos_fiss.php",
			method: "GET",
			dataType: "html"
		});
		req.done(function( contingut_pagina ) {
			$("#cursos-fiss").html(contingut_pagina)
		});
...
function mostrarFaqs() {
	var req = $.ajax({
		url: domain + "ajax/mostrar_preguntes_frequents_generals.php",
		method: "GET",
		data: {
			dispositiu : dispositiu
		},
	...
	req.done(function( accordion ) {
		$("#accord-llistat-preguntes").html(accordion)
	});
