...
urlPagina = '/competencia-digital';

function mostrarTotsCDD() {
	var reqPage = $.ajax({
		url: domain + "ajax/mostrar_pagina_cdd.php",
		method: "GET",
		data: {
...
function mostrarCursosCDD() {
		var req = $.ajax({
			url: domain + "ajax/mostrar_tots_cdd.php",
			method: "GET",
			data: {
				dispositiu : dispositiu
			},
...
function mostrarPeguntesFrequentsCDD() {
	var req = $.ajax({
		url: domain + "ajax/mostrar_preguntes_frequents_cdd.php",
		method: "GET",
		data: {
			dispositiu : dispositiu
		},
