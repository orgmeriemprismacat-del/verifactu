...
function aplicarFiltreCheckbox(check, idThis) {
	...
	if (check) {
		...
		if (objThis.hasClass('hores'))
			...
			console.log("Error. No existeix el filtre marcat");
	}
	else {
...
function eliminarFiltres() {
	filtres = [[0], [], [], [], 'ordre|TITOL|ASC|1'] //edicions, hores, temes, nivells, ordre
	if (screenWidthCurs>=limitPantallaTablet)
		mostrarModalLoading();
