...
urlPagina = '/inscripcions/ja-som-mestres-ara-que';
tipus = 0;
...
function mostrarInscripcio() {
	var requestPage  = $.ajax({
		async: !0,
		url: path + "ajax/mostrar_inscripcio_prova_promojasom.php",
		method: "GET",
		data: {
			url : urlPagina,
			tipus : tipus,
	...
	requestPage.done(function( cursos ) {
		...
		$('.form-dades').on('click', ':checkbox', function() {
			...
			{
				checkCarnet = 0; checkUSOC = 0; checkDiscapacitat = 0; checkDiscapacitat = 0; checkFamMono = 0; checkFamNum = 0;
...
function enviarInscripcio() {
	...
	requestInscrDupl.done(function( msgInscDupl ) {
		if ( !msgInscDupl.toLowerCase().includes("error") && msgInscDupl == '' ) {
			var sendInscr = $.ajax({
				url: path + "ajax/enviarInscripcio_prova_promojasom.php",
				data: {
					tipusCurs: tipusCurs,
					nom: nom,
					cog: cog,
