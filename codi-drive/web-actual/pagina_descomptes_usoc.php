  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      let path = window.location.pathname.split('?')[0];
			let pathNom="/json/descomptes.jsonld";
...
<body class="index">
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/descomptes.min.css?ver=1.0' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarDescomptesUsoc.min.js?ver=2.0"></script>
