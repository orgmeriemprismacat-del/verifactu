...
<body class="index">
   ...
   <div id='cnt-pagament' class="prisma-container container separacio-peu" role="main">
      ...
      $url="https://www.prisma.cat/realitzaPagamentTallerAutomatic.php?idPag=".$idPag."&codiCurs=".$cursPag."&dni=".$dniTitularPag."&order=".$order."&frac=".$frac."&import=".$importPagare;
   ...
   <script async src="https://www.prisma.cat/js1619773569/mostrarEfectuarPagamentTallerAutomatic.js?ver=2.0"></script>
