...
function missatgeErrorTallerNoDisponbile() {
	...
	$msgVisit = "Si t'interessa quan tornarà a estar disponible,
	posa't en <a href='https://www.prisma.cat/contacte'
	title='Contacte amb PrisMa'>contacte amb nosaltres</a>!</p>";
	echo missatgeErrorNoDisponible($msgError, $msgVisit);
}
...
function mostrarPaginaNoActiva() {
	$msgError = "El recurs no està disponible!";
	$msgVisit = "Visita el nostre
	<a href='https://campus.prisma.cat/'>Campus Virtual</a>
	per visualitzar el recurs.</p>";
	echo missatgeErrorNoDisponible($msgError, $msgVisit);
