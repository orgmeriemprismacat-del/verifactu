...
$mostrar="
	...
	<picture>
		...
		<div class='escrit d-flex flex-column w-100 h-100 position-absolute justify-content-center align-items-center px-1'>
			...
			<button onclick=\"location.href='https://www.prisma.cat/tallers/cuida-veu-un-mati-practica'\" title='Formació pràctica per evitar fatiga vocal i lesions! | PrisMa'>Més informació</a>
		</div>
	</div>";
