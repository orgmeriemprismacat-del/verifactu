...
$linkImg = "https://www.prisma.cat/img/banners/competencia-digital-2025-2026.jpg";
$dscImg = "Cursos amb acreditació CDD!";
...
$mostrar="
	...
	<img data-src='".$linkImg."' alt=\"".$dscImg."\" src='".$linkImg."'
			class='baner trobades position-relative text-white d-flex flex-column justify-content-center align-items-center lazyload'/>
		</picture>
		<div class='escrit d-flex flex-column w-100 h-100 position-absolute justify-content-center align-items-center px-1'>
			<h4 class='text-white text-center font-weight-bold mt-0'>".$dscImg."</h4>
			<p class='text-white py-3 mb-0 text-center'>Cursos amb acreditació de la Competència Digital Docent (CDD)</p>
			<button onclick=\"location.href='https://www.prisma.cat/competencia-digital'\"
