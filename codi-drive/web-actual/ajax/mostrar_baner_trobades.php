...
$linkImg = "https://www.prisma.cat/img/banners/trobades-online-2025-2026.jpg";
$dscImg = "Trobades en línia!";
...
$mostrar="
	...
	<picture>
		...
		<img data-src='".$linkImg."' alt=\"".$dscImg."\" src='".$linkImg."'
			class='baner position-relative position-relative trobades text-white d-flex flex-column justify-content-center align-items-center lazyload'/>
		</picture>
		<div class='escrit d-flex flex-column w-100 h-100 position-absolute justify-content-center align-items-center px-1'>
			<h4 class='text-white text-center font-weight-bold mt-0'>Trobades en línia!</h4>
			<p class='text-white py-3 mb-0 text-center'>Càpsules a l'abast de tothom</p>
			<button onclick=\"location.href='https://www.prisma.cat/trobades-en-linia'\"
			title='Trobades en línia | PrisMa'>Més informació</a>
		</div>
	</div>";
