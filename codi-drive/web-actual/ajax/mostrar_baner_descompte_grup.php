...
$linkImg = "https://www.prisma.cat/img/banners/descomptes-grups-2025-2026.jpg";
$dscImg = "Descompte per a grups i centres escolars!";
...
$mostrar="
	...
	<picture>
		...
		<div class='escrit d-flex flex-column w-100 h-100 position-absolute justify-content-center align-items-center px-1'>
			<h4 class='text-white text-center font-weight-bold mt-0'>Descompte per a grups i centres escolars!</h5>
			<p class='text-white py-3 mb-0 text-center'>Compartiu formació amb amics o companys!</p>
			<button onclick=\"location.href='https://www.prisma.cat/descompte-curs-grup'\" title='Compartiu formació amb amics o companys! | PrisMa'>Més informació</a>
		</div>
	</div>";
