...
try {
   ...
   $connexio->closeStmt();
	...
	$textIntroCasDesc = "<p>Hem rebut la teva sol·licitud amb les dades següents i ens hem posat en contacte amb la FEUSOC (la Federació d’Educació de la Unió Sindical Obrera de Catalunya) perquè ens confirmin que ets afiliat/da al sindicat:</p>";
	...
	$missatge .= "<div style='background-color:#e8ecf5;border:1px solid #d7deee;border-radius:2px;padding:5px 25px;margin-bottom:20px'>
		...
		<p><strong>Preu:</strong> ".$anticipiPreu." euros</p>
	</div>";
	$missatge .= "<p>Un cop validat, acabarem el procés de reserva de la plaça i t’enviarem un correu de confirmació.</p>";
	...
	<p>Confirma’ns si us plau, si aquesta persona és afiliada per tal de poder bonificar el preu i continuar el procés d’inscripció.</p>
	<p>Atentament,</p>";
