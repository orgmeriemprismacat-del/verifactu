...
try {
   ...
   $connexio->closeStmt();
	...
	if ( $tipusDescompte == 4 || $tipusDescompte == 5 || $tipusDescompte == 6 || $tipusDescompte == 7 ) {
		// CAS USOC
		if ( $tipusDescompte == 4 ) {
	...
	if ($comentaris != '' || $tipusDescompte==4 || $tipusDescompte == 5 || $tipusDescompte == 6 || $tipusDescompte == 7 )
		$subjectMailInsc .= " + O";
	/* ######################################################################### */
