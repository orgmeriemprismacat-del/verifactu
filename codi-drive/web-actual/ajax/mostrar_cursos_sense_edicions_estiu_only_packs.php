...
try {
   ...
   include("../inc/buscantCursosDisponiblesSenseEdicionsEstiuOnlyPacks.php");
   ...
   // else
   //    $pagination .= "<div class='text-center w-100 pt-4'>Incloure cursos que només s'ofereixen a l'estiu.</div>";
