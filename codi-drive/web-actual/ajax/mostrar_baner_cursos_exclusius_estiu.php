...
$linkImg = "https://www.prisma.cat/img/banners/cursos-exclusius-estiu.jpg";
$dscImg = "Cursos que s'ofereixen només a l'estiu";
...
$mostrar="
	...
	<div class='escrit d-flex flex-column w-100 h-100 position-absolute justify-content-center align-items-center px-1'>
		<h4 class='text-white text-center font-weight-normal mt-0'>Cursos que s'ofereixen només a l'estiu</h4>
		<p class='text-white py-3 mb-0 text-center'>Cursos que s'ofereixen única i exclusivament a l'estiu</p>
		<button onclick=\"location.href='https://www.prisma.cat/cursos-exclusius-estiu'\" title='Cursos que s'ofereixen només a l'estiu | PrisMa'>Més informació</a>
	</div>
</div>";
