	...
	<nav id='nav-header' class='navbar prisma-nav w-100 background-prisma'>
		<div class='container'>
			...
			<div id='sideNavPrisma' class='navbarPrisma'>
			  ...
			  <ul id='navBarPrisma' class='nav navbar-nav navbar-right ps2'>
				...
				<li class='dropdown li-white juliol'>
				  <a href='https://www.prisma.cat/packs' class='px-1 px-lg-2 py-3' role='button' target='_self' title='Packs de cursos'><em>Packs</em></a> <div class='float-right ml-1 mr-2' style='margin-top: 5px;'><div class='d-flex justify-content-center align-items-center mr-0' style='background-color: #fff; border-radius: 50%; height: 12px; width: 9px;'><i class='fas fa-exclamation-circle' style='color:#C94551;'></i></div></div>
				</li>
				<li class='dropdown li-white'>
				  <a href='https://www.prisma.cat/perfils-professionals' class='px-1 px-lg-2 py-3' role='button' target='_self' title='Cursos de PrisMa amb perfils professionals'>Perfils</a> <div class='float-right ml-1 mr-2' style='margin-top: 5px;'><div class='d-flex justify-content-center align-items-center mr-0' style='background-color: #fff; border-radius: 50%; height: 12px; width: 9px;'><i class='fas fa-exclamation-circle' style='color:#C94551;'></i></div></div>
				</li>
				<!--<li class='dropdown li-white juliol'>
				...
				<li class='dropdown li-white juliol'>
				  <a href='https://www.prisma.cat/cursos/07/2026' class='px-1 px-lg-2 py-3' role='button' target='_self' title='Cursos de juliol'>
				...
				<li class='dropdown li-white'>
				  <a href='https://www.prisma.cat/tastets' class='px-1 px-lg-2 py-3' role='button' target='_self' title='Tastets gratuïts d&#39;alguns cursos'>Tastets</a> <div class='float-right ml-1 mr-2' style='margin-top: 5px;'><div class='d-flex justify-content-center align-items-center mr-0' style='background-color: #fff; border-radius: 50%; height: 12px; width: 9px;'><i class='fas fa-exclamation-circle' style='color:#C94551;'></i></div></div>
				</li>
				<li class='dropdown li-white juliol'>
				  <a href='https://www.prisma.cat/competencia-digital' class='px-1 px-lg-2 py-3' role='button' target='_self' title='Acreditació de la Competència Digital Docent (CDD)'>
					CDD</a> <!--<div class='float-right ml-1 mr-2' style='margin-top: 5px;'><div class='d-flex justify-content-center align-items-center mr-0' style='background-color: #fff; border-radius: 50%; height: 12px; width: 9px;'><i class='fas fa-exclamation-circle' style='color:#C94551;'></i></div></div>-->
				</li>
