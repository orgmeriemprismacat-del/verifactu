  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      if (vectPath[2]) pathNom="/json/tastets"+vectPath[2]+".jsonld";
      else pathNom="/json/tastets.jsonld";
...
<body class="index">
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/tastets.min.css?ver=1.0' />
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/blocTastet.min.css?ver=1.0' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarTastets.min.js?ver=2.0"></script>
