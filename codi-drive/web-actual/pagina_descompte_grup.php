  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      if (vectPath[2]) pathNom="/json/descompte_curs"+vectPath[2]+".jsonld";
      else pathNom="/json/descompte_curs.jsonld";
...
<body class="index">
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/descompte-grup.min.css?ver=5.1' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarDescompteGrup.min.js?ver=8.3"></script>
