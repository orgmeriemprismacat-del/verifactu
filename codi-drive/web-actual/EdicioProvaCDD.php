...
class Edicio {
   ...
   */
   public function __construct($codiCurs,$dispositiu,$any,$mes,$hores,$datai,$dataf,$curs_escolar,$codi_gtaf,$data_res,$codi_fiss,$estat,$cdd) {
      require_once 'CursProvaCDD.php';
