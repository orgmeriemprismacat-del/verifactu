...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<link rel='stylesheet' href='https://www.prisma.cat/css1619773569/estructura.min.css?ver=6.4' />
		<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
		<script async>
			$.getJSON("/json/packs.jsonld",function(data){$("<script/>",{"type":"application/ld+json",html:JSON.stringify(data)}).appendTo("head");});
		</script>
	</head>
	<body class="index">
		<header></header>

		<div id='cursos' class="cnt-packs prisma-container" role="main">
		...
		<script async src="https://www.prisma.cat/js1619773569/mostrarPacks.min.js?ver=20.6"></script>
		<link rel='stylesheet' href='https://www.prisma.cat/css1619773569/packs.min.css?ver=1.1' />
		<link rel='stylesheet' href='https://www.prisma.cat/css1619773569/curs.min.css?ver=9.3' />
		<link rel='stylesheet' href='https://www.prisma.cat/css1619773569/pack.min.css?ver=9.3' />
		...
		<script defer src="https://www.prisma.cat/js1619773569/mostrarPacksPostLoad.min.js?ver=20.2"></script>
