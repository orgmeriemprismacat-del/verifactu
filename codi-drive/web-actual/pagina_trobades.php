  ...
  function consentGrantedAnalyticsStorage() {
   ...
   <script>
      ...
      let vectPath = path.split('/'),
          pathNom = vectPath[2];
      if (vectPath[2]) pathNom="/json/trobades"+vectPath[2]+".jsonld";
      else pathNom="/json/trobades.jsonld";
...
<body class="index">
   ...
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/trobades.min.css?ver=5.0' />
   <link rel='stylesheet' href='https://www.prisma.cat/css1619773569/blocTrobada.min.css?ver=5.0' />
   <script async src="https://www.prisma.cat/js1619773569/mostrarTrobades.min.js?ver=6.0"></script>
