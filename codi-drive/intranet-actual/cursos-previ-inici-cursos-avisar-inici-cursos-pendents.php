...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Avís cursos pendents | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/cursos-previ-inici-cursos-avisar-inici-cursos-pendents.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/cursos-previ-inici-cursos-avisar-inici-cursos-pendents.js?ver=7.2"></script>
	</body>
</html>
<?php } ?>
