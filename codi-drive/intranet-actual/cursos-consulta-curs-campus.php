...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Consulta els curs en el campus | Intranet</title>
	...
	<body>
		...
		<!-- <link rel="stylesheet" href="https://intranet.prisma.cat/css/cursos-consulta-curs-campus.css?ver=1.0"/> -->
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/cursos-consulta-curs-campus.js?ver=1.0"></script>
	</body>
</html>
<?php } ?>
