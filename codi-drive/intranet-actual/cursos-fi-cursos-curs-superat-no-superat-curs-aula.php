...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Curs superat i no superat | Intranet</title>
		...
		<!-- Fontawesome -->
		<script src="https://kit.fontawesome.com/4c5c8acff3.js" crossorigin="anonymous"></script>
	</head>
	<body>
		<div class="contingut">
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/cursos-fi-cursos-curs-superat-no-superat.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/cursos-fi-cursos-curs-superat-no-superat-curs-aula.js?ver=1.2"></script>
	</body>
</html>
<?php } ?>
