...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Canviar fòrums de P/R a debat simple | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/cursos-fi-cursos-canviar-forums-debat-simple.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/cursos-fi-cursos-canviar-forums-debat-simple.js?ver=1.0"></script>
	</body>
</html>
<?php } ?>
