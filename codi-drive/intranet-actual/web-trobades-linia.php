...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Trobades en línia | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/trobades-linia.css?ver=2.0"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.2"></script>
		<script src="https://intranet.prisma.cat/js/web-trobades-linia.js?ver=1.0"></script>
	</body>
</html>
<?php } ?>
