...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Cursos nous | Intranet</title>
		...
		<!-- FullCalendar.io idioma català -->
		<script src="https://cdn.jsdelivr.net/npm/fullcalendar@5.10.2/locales/ca.js"></script>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/cursos-nous.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/cursos-nous.js?ver=1.0"></script>
		<!-- CSS Roboto -->
