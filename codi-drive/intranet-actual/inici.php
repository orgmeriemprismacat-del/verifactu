...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/inici.min.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general_v5.min.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/inici.min.js?ver=5.0"></script>
	</body>
</html>
<?php } ?>
