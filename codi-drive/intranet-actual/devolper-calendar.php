...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Calendari Developer | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/calendar-legends.min.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general_v5.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/devolper-calendar.min.js?ver=1.1"></script>
	</body>
</html>
<?php } ?>
