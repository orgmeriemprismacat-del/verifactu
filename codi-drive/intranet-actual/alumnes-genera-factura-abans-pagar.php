...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Consulta / Genera factura abans de pagar | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/alumnes-genera-factura-abans-pagar.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/alumnes-genera-factura-abans-pagar.js?ver=1.0"></script>
