...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Generar fitxer pujada alumnes | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/cursos-inici-cursos-pujar-alumnes.css?ver=1.5"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/cursos-inici-cursos-pujar-alumnes.js?ver=1.1"></script>
	</body>
</html>
<?php } ?>
