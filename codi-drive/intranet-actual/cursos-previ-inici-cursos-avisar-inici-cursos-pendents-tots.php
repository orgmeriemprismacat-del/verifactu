...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Avís cursos pendents (tots) | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/cursos-previ-inici-cursos-avisar-inici-cursos-pendents-tots.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/cursos-previ-inici-cursos-avisar-inici-cursos-pendents-tots.js?ver=1.0"></script>
	</body>
</html>
<?php } ?>
