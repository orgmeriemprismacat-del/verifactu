...
function mostrarModalLoading() {
	// var myModal = new bootstrap.Modal(document.getElementById("modalLoading"), {});
	// myModal.show();
	bootstrap.Modal.getOrCreateInstance(document.getElementById('modalLoading')).show();
}
...
function mostrarModalError() {
	// var myModal = new bootstrap.Modal(document.getElementById("modalErrors"), {});
	// myModal.show();
	bootstrap.Modal.getOrCreateInstance(document.getElementById('modalErrors')).show();
}
...
function amagarModalError() {
	// var myModal = new bootstrap.Modal(document.getElementById("modalErrors"), {});
	// myModal.hide();
	bootstrap.Modal.getInstance(document.getElementById('modalErrors')).hide();
}
...
function validNumero(valor) {
	var valid = ( valor == '' || ( valor != "" && parseFloat(valor) >= 0) );
	return valid;
}
