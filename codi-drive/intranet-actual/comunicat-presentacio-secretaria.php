...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Comunicat / Presentació Secretaria | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/comunicat.min.css?ver=1.0"/>
		<!-- <link rel="stylesheet" href="https://intranet.prisma.cat/css/comunicat-presentacio-secretaria.min.css?ver=1.0"/> -->
		<script src="https://intranet.prisma.cat/js/general_v5.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/comunicat-presentacio-secretaria.min.js?ver=1.3"></script>
