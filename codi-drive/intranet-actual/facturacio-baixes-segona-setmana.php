...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Baixes 2a setmana | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://intranet.prisma.cat/css/facturacio-baixes-segona-setmana.css?ver=1.0"/>
		<script src="https://intranet.prisma.cat/js/general_v5.js?ver=1.0"></script>
		<script src="https://intranet.prisma.cat/js/facturacio-baixes-segona-setmana.js?ver=1.1"></script>
	</body>
</html>
<?php } ?>
