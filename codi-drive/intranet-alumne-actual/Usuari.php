	...
	*/
	class Usuari
	{
	   ...
	   */
		...
		/**
	   * @brief Mostra el idUser
	   * @return Mostra el idUser
	   */
		function getIdUser() {
			return $this->idUser;
		}
		...
		/**
	   * @brief Mostra el urlPicture
	   * @return Mostra el urlPicture
	   */
		function getEmail() {
			return $this->email;
		}
		...
		/**
	   * @brief Mostra el city
	   * @return Mostra el city
	   */
		...
		/**
	   * @brief Mostra el email
	   * @return Mostra el email
	   */
		function getCity() {
			return $this->city;
		}
	   ...
	   */
		...
		/**
	   * @brief Afegeix el password
	   * @return Afegeix el password
	   */
		function setPass( $password ) {
			if ($password != null && $password != '')
				$this->pasword = new Text($password);
		}
	   ...
	   */
		...
		/**
	   * @brief Afegeix el email
	   * @return Afegeix el email
	   */
		...
		/**
	   * @brief Afegeix el city
	   * @return Afegeix el city
	   */
		...
		/**
	   * @brief Afegeix el idPicture
	   * @return Afegeix el idPicture
	   */
		...
		function setRols( $rols ) {
			if ($rols != null && $rols != '') {
				...
				for ($i=0; $i<count($vectRols); $i++) {
					$j = 0; $trobat = false;
					while ($j < count($this->rols) && !$trobat) {
