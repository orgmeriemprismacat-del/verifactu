...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Els meus cursos | Intranet</title>
	...
	<body>
		...
		<link rel="stylesheet" href="https://campus.prisma.cat/intranet-alumnes/css/table-responsive.css?ver=6.0"/>
		...
		<link rel="stylesheet" href="https://campus.prisma.cat/intranet-alumnes/css/meus-cursos.css?ver=6.1"/>
		<script src="https://campus.prisma.cat/intranet-alumnes/js/general.js?ver=7.0"></script>
		<script src="https://campus.prisma.cat/intranet-alumnes/js/meus-cursos.js?ver=5.2"></script>
	</body>
</html>
<?php } ?>
