...
try {
	...
	$cntSocial = "<div class='cnt-xarxes pt-3 w-100'>
		...
		<div class='d-flex flex-column justify-content-around align-items-center w-100'>
			...
			<a class='d-flex align-items-center justify-content-center' aria-label='X' role='link' rel='noopener' title='X de PrisMa' href='https://x.com/PrisMaFormacio' target='_blank'>
				<i class='fa-brands fa-x-twitter peu' aria-hidden='true'></i>
			</a>
			<div class='d-flex align-items-center justify-content-center'>
