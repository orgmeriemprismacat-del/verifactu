	...
	class Date
	{
	   ...
	   */
		...
		*/
		...
		/*
		* @brief Obtens el pronom de «d'» o «de» segons el dia de la data
		* @return Si el dia és 1 o 11, obtens el pronom de «d'». Altrament retorna «de»
		*/
		public function getPronomD() {
			$dia = $this->getDia();
		...
		/*
		* @brief Obtens el pronom de «d'» o «de» segons el mes de la data
		* @return Si el mes és 4, 8, 10, obtens el pronom de «d'». Altrament retorna «de»
		*/
		public function getPronomD_ByMes() {
			$dia = $this->getMes();

			$textl = "de ";
			if ( $dia == '4' or $dia == '8' or $dia == '10' ) {
				$textl = "d'";
			}
			return $textl;
		}
