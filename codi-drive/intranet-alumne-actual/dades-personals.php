...
<html lang="ca" prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# video: http://ogp.me/ns/video#">
	<head>
		...
		<title>Les meves dades | Intranet</title>
		...
		<!-- Fontawesome -->
		<script src="https://kit.fontawesome.com/65815b6a64.js"></script>
	...
	<body>
		<div class="contingut">
			<div class="sidebar h-100 position-fixed bg-white active"></div>
		...
		<link rel="stylesheet" href="https://campus.prisma.cat/intranet-alumnes/css/dades-personals.css?ver=6.0"/>
		<script src="https://campus.prisma.cat/intranet-alumnes/js/general.js?ver=6.1"></script>
		<script src="https://campus.prisma.cat/intranet-alumnes/js/dades-personals.js?ver=4.1"></script>
	</body>
</html>
<?php } ?>
