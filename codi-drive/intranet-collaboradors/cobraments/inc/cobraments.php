...
{
  echo "<p align=center style=font-size:14px><br /><br />Per accedir a la Intranet has d'estar identificat/da en el <strong>Campus Virtual anterior</strong>.<br /><br /><a href=https://campus.prisma.cat/login/index.php target=_blank style=text-decoration:none>campus.prisma.cat/login/index.php</a></p>";
}
?>
