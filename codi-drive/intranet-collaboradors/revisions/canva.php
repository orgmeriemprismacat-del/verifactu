...
//Canviar hores per les hores o el codi del curs en concret
$hores = "canva";
$user = $USER->username;
   ...
   if (isloggedin()) {
      ...
      <script>
         ...
         if (!es_chrome && !es_firefox) {
            ...
            $('#row_revisio').append("<div id='peu' class='text-center my-4'>972 21 75 65 · 678 12 36 87 · <a href='https://www.prisma.cat' target='_blank' style='color:#526b3e; text-decoration: none'>www.prisma.cat</a> · secretaria@prisma.cat</div>");
            mostrarRevisio();
         }
      </script>
      <?php
