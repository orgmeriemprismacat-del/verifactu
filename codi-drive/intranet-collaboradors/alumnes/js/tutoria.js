...
var fraseNoExisteixTutor="<div class='error'><img class='capcalera' src='https://campus.prisma.cat/intranet-collaboradors/alumnes/img/banner_prisma_rectangle.png'></div>";
...
fraseNoExisteixTutor+="<p>972 21 75 65 · 678 12 36 87 · ";
...
function enviarConsulta() {
  ...
  enviarConsulta.done(function(message) {
    if (message == "ok") {
       ...
       missatgeConsultaOK+="src='https://campus.prisma.cat/intranet-collaboradors/alumnes/img/banner_prisma_rectangle.png'></div>";
       ...
       missatgeConsultaOK+="<p>972 21 75 65 · 678 12 36 87 · ";
