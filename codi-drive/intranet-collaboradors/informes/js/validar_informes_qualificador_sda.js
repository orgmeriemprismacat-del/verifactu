...
function comprovar(form,boton,n)
{
	...
	else // Envia i acaba
	{
		...
		else
		{
			...
			if ((avis_diferencia3!="" || avis_suspesos!="") && (avis1!="" || avis2!="" || avis5!="" || avis6!="" || avis7!="" || avis8!=""))
			{
				separacio="\n\n";
			}
			if(avis1!="" || avis2!="" || avis5!="" || avis6!="" || avis7!="" || avis8!="")
			{
				falta="FALTA:\n";
			}

			alert(atencio + avis_diferencia + avis_diferencia2 + avis_diferencia3 + avis_suspesos + separacio + falta + avis1 + avis2 + avis5 + avis6 + avis7 + avis8);
		}
	}
}
