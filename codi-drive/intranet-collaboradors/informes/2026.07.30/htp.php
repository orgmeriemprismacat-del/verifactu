							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" cellpadding="0" cellspacing="0" class="taula">
										<?php
											...
											{
                                              	//include 'inc/dades_informe_suspesos_htp.php';
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg30" value="C" <?php if ($cadena[30]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg32" value="si" <?php if ($cadena[32]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg32" value="no" <?php if ($cadena[32]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg33" value="si" <?php if ($cadena[33]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg33" value="no" <?php if ($cadena[33]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="2">
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg28" value="C">
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg29" value="C">
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg30" value="C">
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg32" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg32" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg33" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg33" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="2">
