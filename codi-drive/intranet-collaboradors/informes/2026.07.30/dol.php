...
<html>
	...
	/**************************************************/
							...
							else if ($_POST['botPress'] == 'Desa sense enviar')
							{
								...
								{
									echo ("<p class=enviat>Hi ha hagut algun problema en desar les dades. Si us plau, contacta amb suport@prisma.cat per solucionar el problema.</p>");
								}
								// insereix o actualitza els usuaris suspesos, en el cas que n'hi hagi (nsuspesos - 1)
								for ($i=1;$i<$_POST[nsuspesos];$i++)
								{
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg23" value="si" <?php if ($cadena[23]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg23" value="no" <?php if ($cadena[23]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg24" value="si" <?php if ($cadena[24]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg24" value="no" <?php if ($cadena[24]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg23" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg23" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg24" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg24" value="no">
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
