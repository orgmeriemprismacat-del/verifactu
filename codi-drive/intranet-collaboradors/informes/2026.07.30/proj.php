...
include('inc/enunciats/e-'.mb_strtolower($course, 'UTF-8').'.php');
 /***************************************************************/
// preparem el correu
$to = "secretaria@prisma.cat;tutoria@prisma.cat";
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg31" value="5" <?php if ($cadena[30]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
                                        <tr>
											<td colspan="2">
										...
										<tr>
											...
											<td align="center">
												<input type="radio" name="preg44" value="0" <?php if ($cadena[44]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="1" <?php if ($cadena[44]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="2" <?php if ($cadena[44]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="3" <?php if ($cadena[44]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="4" <?php if ($cadena[44]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="5" <?php if ($cadena[44]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg45" value="C" <?php if ($cadena[45]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
												<input type="radio" name="preg45" value="0" <?php if ($cadena[45]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="1" <?php if ($cadena[45]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="2" <?php if ($cadena[45]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="3" <?php if ($cadena[45]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="4" <?php if ($cadena[45]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="5" <?php if ($cadena[45]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg46" value="C" <?php if ($cadena[46]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
												<input type="radio" name="preg46" value="0" <?php if ($cadena[46]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="1" <?php if ($cadena[46]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="2" <?php if ($cadena[46]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="3" <?php if ($cadena[46]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="4" <?php if ($cadena[46]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="5" <?php if ($cadena[46]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg47" value="C" <?php if ($cadena[47]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
												<input type="radio" name="preg47" value="0" <?php if ($cadena[47]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="1" <?php if ($cadena[47]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="2" <?php if ($cadena[47]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="3" <?php if ($cadena[47]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="4" <?php if ($cadena[47]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="5" <?php if ($cadena[47]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg48" value="C" <?php if ($cadena[48]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
												<input type="radio" name="preg48" value="0" <?php if ($cadena[48]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="1" <?php if ($cadena[48]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="2" <?php if ($cadena[48]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="3" <?php if ($cadena[48]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="4" <?php if ($cadena[48]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="5" <?php if ($cadena[48]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg49" value="C" <?php if ($cadena[49]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
												<input type="radio" name="preg49" value="0" <?php if ($cadena[49]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="1" <?php if ($cadena[49]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="2" <?php if ($cadena[49]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="3" <?php if ($cadena[49]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="4" <?php if ($cadena[49]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="5" <?php if ($cadena[49]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg50" value="C" <?php if ($cadena[50]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
												<input type="radio" name="preg50" value="0" <?php if ($cadena[50]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="1" <?php if ($cadena[50]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="2" <?php if ($cadena[50]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="3" <?php if ($cadena[50]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="4" <?php if ($cadena[50]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="5" <?php if ($cadena[50]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg51" value="si" <?php if ($cadena[51]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg51" value="no" <?php if ($cadena[51]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg52" value="si" <?php if ($cadena[52]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg52" value="no" <?php if ($cadena[52]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg25" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg25" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg25" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg25" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg25" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg25" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg26" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg26" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg26" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg26" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg26" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg26" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg27" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg27" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg27" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg27" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg27" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg27" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="8" class="modul">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg28" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg28" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg28" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg28" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg28" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg28" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg29" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg29" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg29" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg29" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg29" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg29" value="5">
											</td>
										</tr>
                                        <tr class="borde_inferior">
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg30" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg30" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg30" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg30" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg30" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg30" value="5">
											</td>
										</tr>
                                        <tr class="borde_inferior">
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg31" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg31" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg31" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg31" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg31" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg31" value="5">
											</td>
										</tr>
                                        <tr>
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg32" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg32" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg32" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg32" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg32" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg32" value="5">
											</td>
										</tr>
										<tr>
											<td class="celda" colspan="8">&nbsp;
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg33" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg33" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg33" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg33" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg33" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg33" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg34" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg34" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg34" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg34" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg34" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg34" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="8" class="modul">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg35" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg35" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg35" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg35" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg35" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg35" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg36" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg36" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg36" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg36" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg36" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg36" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="8" class="modul">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg37" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg37" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg37" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg37" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg37" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg37" value="5">
											</td>
										</tr>
										<tr>
											...
											<td align="center">
												<input type="radio" name="preg38" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg38" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg38" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg38" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg38" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg38" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="8" class="modul">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg39" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg39" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg39" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg39" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg39" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg39" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg40" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg40" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg40" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg40" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg40" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg40" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="8" class="modul">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg41" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg41" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg41" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg41" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg41" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg41" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg42" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg42" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg42" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg42" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg42" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg42" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="8" class="modul">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg43" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg43" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg43" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg43" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg43" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg43" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="2">
											...
											<td align="center">
												<input type="radio" name="preg44" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg44" value="5">
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg45" value="C">
											</td>
                                            <td align="center">
												<input type="radio" name="preg45" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg45" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg46" value="C">
											</td>
                                            <td align="center">
												<input type="radio" name="preg46" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg46" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg47" value="C">
											</td>
                                            <td align="center">
												<input type="radio" name="preg47" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg48" value="C">
											</td>
                                            <td align="center">
												<input type="radio" name="preg48" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg49" value="C">
											</td>
                                            <td align="center">
												<input type="radio" name="preg49" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg49" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
											...
											<td align="center">
												<input type="radio" name="preg50" value="C">
											</td>
                                            <td align="center">
												<input type="radio" name="preg50" value="0">
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="1">
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="2">
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="3">
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="4">
											</td>
											<td align="center">
												<input type="radio" name="preg50" value="5">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg51" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg51" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg52" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg52" value="no">
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
