							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg44" value="C" <?php if ($cadena[44]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg47" value="si" <?php if ($cadena[47]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="no" <?php if ($cadena[47]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg48" value="si" <?php if ($cadena[48]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="no" <?php if ($cadena[48]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg42" value="C">
											</td>
                                            <td align="center">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg43" value="C">
											</td>
                                            <td align="center">
                                        ...
                                        <tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg44" value="C">
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg47" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg47" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg48" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg48" value="no">
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
