							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg36" value="si" <?php if ($cadena[36]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg36" value="no" <?php if ($cadena[36]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg36" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg36" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
