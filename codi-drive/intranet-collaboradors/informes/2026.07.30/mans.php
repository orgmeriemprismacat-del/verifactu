        ...
        <div id="tot">
            ...
            <div id="cos">
               ...
               $result_g = mysqli_query ($conexion, "SELECT codic, guardat, finalitzat FROM informe_tutor INNER JOIN cursos ON codic=id_Curs WHERE codic='".$curs."'");
					...
					// el curs pertany al tutor
					if (mysqli_num_rows($result_pertany)>0)
					{

						$result_g = mysqli_query ($conexion, "SELECT codic, guardat, finalitzat FROM informe_tutor, cursos WHERE codic='".$curs."' AND codic=id_Curs AND DNI_TUTOR LIKE '".$USER->username."%'");
