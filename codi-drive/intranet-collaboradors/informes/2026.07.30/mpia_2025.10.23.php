							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg25" value="C" <?php if ($cadena[25]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="cadena[26]" value="C" <?php if ($cadena[26]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
												<input type="radio" name="cadena[26]" value="0" <?php if ($cadena[26]=='0') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="1" <?php if ($cadena[26]=='1') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="2" <?php if ($cadena[26]=='2') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="3" <?php if ($cadena[26]=='3') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="4" <?php if ($cadena[26]=='4') {echo ('checked');} ?>>
											</td>
											<td align="center">
												<input type="radio" name="cadena[26]" value="5" <?php if ($cadena[26]=='5') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td>
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg28" value="si" <?php if ($cadena[28]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg28" value="no" <?php if ($cadena[28]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg29" value="si" <?php if ($cadena[29]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg29" value="no" <?php if ($cadena[29]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg25" value="C">
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg26" value="C">
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg27" value="C">
											</td>
                                            <td align="center">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg28" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg28" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg29" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg29" value="no">
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
