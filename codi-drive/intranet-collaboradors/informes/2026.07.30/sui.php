...
<html>
	<head>
      ...
      <!-- Activitat JS -->
      <script language="Javascript" src="js/validar_informes_qualificador_sui.js"></script>
	</head>
    <body>
        <div id="tot">
            <div id="cap">
	...
	/**************************************************/
							...
							else
							{
								...
								include 'inc/aprovats_pendents_informe_sui.php';
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" cellpadding="0" cellspacing="0" class="taula">
										<?php
											...
											{
                                              	include 'inc/dades_informe_suspesos_nou_sui.php';
											}
										?>
										<tr>
											<td colspan="2">&nbsp;                            </td>
