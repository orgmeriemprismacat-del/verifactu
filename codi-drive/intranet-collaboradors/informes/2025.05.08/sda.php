...
include('inc/enunciats/e-'.mb_strtolower($course, 'UTF-8').'.php');
 /***************************************************************/
// preparem el correu
<strong>$to = "secretaria@prisma.cat;tutoria@prisma.cat";</strong>
...
<html>
	<head>
      ...
      <!-- Activitat JS -->
      <script language="Javascript" src="js/validar_informes_qualificador_sda.js"></script>
	</head>
    <body>
        <div id="tot">
            <div id="cap">
	...
	/**************************************************/
							...
							else
							{
								...
								include 'inc/aprovats_pendents_informe_sda.php';
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" cellpadding="0" cellspacing="0" class="taula">
										<?php
											...
											{
                                              	include 'inc/dades_informe_suspesos_nou_sda.php';
											}
										?>
										<tr>
											<td colspan="2">&nbsp;                            </td>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr>
											...
											<td align="center">
												<input type="radio" name="preg13" value="si" <?php if ($cadena[13]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg13" value="no" <?php if ($cadena[13]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
							...
							else // mostrem el formulari buit
							{
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="apartat">
											<td>
												ANÀLISI DEL RACÓ D’INTERCANVI <BR />
											</td>
                                            <td width="25" align="center">
                                        ...
                                        <tr>
											...
											<td align="center">
												<input type="radio" name="preg13" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg13" value="no">
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
