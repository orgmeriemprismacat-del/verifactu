									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
                                       ...
                                       <tr class="borde_inferior">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg26" value="C" <?php if ($cadena[26]=='C') {echo ('checked');} ?>>
											</td>
                                            <td align="center">
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr class="borde_inferior">
											...
											<td align="center">
												<input type="radio" name="preg30" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg30" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="4">
											...
											<td align="center">
												<input type="radio" name="preg31" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg31" value="no">
											</td>
										</tr>
										<tr class="borde_inferior">
											<td colspan="2">
