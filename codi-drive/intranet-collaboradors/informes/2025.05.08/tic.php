							...
							else
							{
							 ...
							 ?>
                              ...
                              <tr>
									...
									<input type="button" name="desar" value="Desa sense enviar" onClick="comprovar(this.form,'Desa sense enviar')">&nbsp;<?php if ((($row['dies_passats']>1 && $nsuspesos==0) || ($row['dies_passats']>7 && $nsuspesos>0)) && ($trobat==0)) { ?><input type="button" name="enviar" value="Envia i acaba" onClick="comprovar(this.form,'Envia i acaba',<?php echo $nsuspesos; ?>)"><?php } else { ?><input type="button" name="enviar" value="Envia i acaba" disabled><?php } ?></div>
									</form>
							<?php
