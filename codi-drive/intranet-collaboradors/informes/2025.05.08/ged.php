...
<html>
	<head>
      ...
      <!-- Activitat JS -->
      <script language="Javascript" src="js/validar_informes_qualificador_ged.js"></script>
	</head>
    <body>
        <div id="tot">
            <div id="cap">
	...
	/**************************************************/
							...
							else
							{
								...
								include 'inc/aprovats_pendents_informe_ged.php';
							 ...
							 ?>
									...
									<table border="0" align="center" width="900" vspace="0" cellpadding="0" cellspacing="0" class="taula">
										<?php
											...
											{
                                              	include 'inc/dades_informe_suspesos_nou_ged.php';
											}
										?>
										<tr>
											<td colspan="2">&nbsp;                            </td>
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
										...
										<tr>
											...
											<td align="center">
												<input type="radio" name="preg14" value="si" <?php if ($cadena[14]=='si') {echo ('checked');} ?>>
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg14" value="no" <?php if ($cadena[14]=='no') {echo ('checked');} ?>>
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
									...
									<table border="0" align="center" width="900" vspace="0" style="margin-top:0px; padding-bottom:5px;" cellpadding="0" cellspacing="0" class="celda">
                                       ...
                                       <tr>
                                        ...
                                        <tr>
											...
											<td align="center">
												<input type="radio" name="preg14" value="si">
											</td>
											<td align="center">
												NO
											</td>
											<td align="center">
												<input type="radio" name="preg14" value="no">
											</td>
										</tr>
										<tr>
											<td colspan="8">&nbsp;
